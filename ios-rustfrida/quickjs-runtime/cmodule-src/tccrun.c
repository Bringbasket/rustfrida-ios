...
/* Android mprotect() is page-granular.  For in-memory code, keep executable
   and writable sections on different pages so RX text does not make .data/.bss
   read-only when tiny modules fit in a single page. */
 #define RUN_SECTION_ALIGNMENT 4095
