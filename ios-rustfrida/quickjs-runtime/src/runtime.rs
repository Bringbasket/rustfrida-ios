    ...
    mod tests {
        ...
        fn agent_helpers_route_basic_queries() {
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.rpaths', moduleName: main.image.name, query: null }); if (!(result.kind === 'native.rpaths' && result.hasQuery === false && result.count === result.rpaths.length && typeof result.hasRpaths === 'boolean' && typeof result.uniqueRpathCount === 'number' && typeof result.uniquePathKindCount === 'number' && typeof result.tokenPathCount === 'number' && typeof result.loaderPathCount === 'number' && typeof result.executablePathCount === 'number' && typeof result.rpathTokenCount === 'number' && typeof result.hasTokenPaths === 'boolean' && typeof result.hasLoaderPaths === 'boolean' && typeof result.hasExecutablePaths === 'boolean' && typeof result.hasRpathTokens === 'boolean' && Array.isArray(result.rpathPaths) && Array.isArray(result.pathKinds))) { return false; } if (result.rpaths.length === 0) { return result.hasRpaths === false && result.firstRpath === null && result.lastRpath === null && result.firstPathKind === null && result.lastPathKind === null; } const rpath = result.rpaths[0]; const rpathPath = result.rpathPaths.length === 0 ? null : result.rpathPaths[0]; const pathKind = result.pathKinds.length === 0 ? null : result.pathKinds[0]; return result.hasRpaths === true && typeof result.firstRpath === 'string' && typeof result.lastRpath === 'string' && typeof result.firstPathKind === 'string' && typeof result.lastPathKind === 'string' && (result.longestRpath === null || typeof result.longestRpath === 'string') && (result.longestRpathLength === null || typeof result.longestRpathLength === 'number') && typeof rpath.path === 'string' && typeof rpath.hasPath === 'boolean' && typeof rpath.pathKind === 'string' && typeof rpath.isTokenPath === 'boolean' && typeof rpath.usesLoaderPath === 'boolean' && typeof rpath.usesExecutablePath === 'boolean' && typeof rpath.usesRpathToken === 'boolean' && typeof rpath.pathDepth === 'number' && (rpathPath === null || (typeof rpathPath.path === 'string' && typeof rpathPath.count === 'number' && typeof rpathPath.firstPathKind === 'string' && typeof rpathPath.lastPathKind === 'string' && typeof rpathPath.tokenPathCount === 'number' && typeof rpathPath.loaderPathCount === 'number' && typeof rpathPath.executablePathCount === 'number' && typeof rpathPath.rpathTokenCount === 'number')) && (pathKind === null || (typeof pathKind.pathKind === 'string' && typeof pathKind.count === 'number' && typeof pathKind.firstPath === 'string' && typeof pathKind.lastPath === 'string' && typeof pathKind.tokenPathCount === 'number')); })()"
                    )
