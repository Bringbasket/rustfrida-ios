    ...
    mod tests {
        ...
        fn agent_helpers_route_basic_queries() {
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('objc.protocolMethodInfo NSObject description optional class'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.protocol_method_info', protocolName: 'NSObject', selectorName: 'description', isRequired: false, isInstanceMethod: false }); return value === result.text && (result.methodInfo === null || (result.methodInfo.selector === 'description' && typeof result.methodInfo.typeEncoding === 'string' && typeof result.methodInfo.hasExplicitArguments === 'boolean' && typeof result.methodInfo.hiddenArgumentCount === 'number' && typeof result.methodInfo.returnsVoid === 'boolean' && typeof result.methodInfo.returnsObject === 'boolean' && typeof result.methodInfo.returnsBlock === 'boolean')); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.methods', className: 'NSObject', isClassMethod: false, filter: 'init' }); return result.kind === 'objc.methods' && result.className === 'NSObject' && result.isClassMethod === false && result.filter === 'init' && result.hasFilter === true && result.count === result.methods.length && typeof result.hasMethods === 'boolean' && ((result.methods.length === 0 && result.hasMethods === false && result.firstSelector === null && result.lastSelector === null) || (result.hasMethods === true && typeof result.firstSelector === 'string' && typeof result.lastSelector === 'string' && typeof result.methods[0].typeEncoding === 'string' && typeof result.methods[0].returnTypeName === 'string' && Array.isArray(result.methods[0].argumentTypeNames) && typeof result.methods[0].methodTypeInfo === 'object' && Array.isArray(result.methods[0].selectorParts) && typeof result.methods[0].selectorPartCount === 'number' && typeof result.methods[0].hasSelectorArguments === 'boolean')); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.exports', moduleName: 'libsystem_malloc.dylib', query: 'malloc' }); return result.kind === 'native.exports' && result.moduleName === 'libsystem_malloc.dylib' && result.query === 'malloc' && result.hasQuery === true && result.count === result.symbols.length && typeof result.hasSymbols === 'boolean' && ((result.symbols.length === 0 && result.hasSymbols === false && result.firstSymbolName === null && result.lastSymbolName === null) || (result.hasSymbols === true && typeof result.firstSymbolName === 'string' && typeof result.lastSymbolName === 'string' && typeof result.symbols[0].moduleBase === 'string' && typeof result.symbols[0].offsetHex === 'string' && typeof result.symbols[0].hasModuleName === 'boolean' && typeof result.symbols[0].hasName === 'boolean')); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.dyld_info', moduleName: main.image.name }); return result.kind === 'native.dyld_info' && (result.dyldInfo === null || (typeof result.dyldInfo.commandName === 'string' && typeof result.dyldInfo.commandRequiresDyld === 'boolean' && typeof result.dyldInfo.rebaseOffHex === 'string' && typeof result.dyldInfo.rebaseEndHex === 'string' && typeof result.dyldInfo.hasRebaseInfo === 'boolean' && typeof result.dyldInfo.bindEndHex === 'string' && typeof result.dyldInfo.hasBindInfo === 'boolean' && typeof result.dyldInfo.weakBindEndHex === 'string' && typeof result.dyldInfo.hasWeakBindInfo === 'boolean' && typeof result.dyldInfo.lazyBindEndHex === 'string' && typeof result.dyldInfo.hasLazyBindInfo === 'boolean' && typeof result.dyldInfo.exportSizeHex === 'string' && typeof result.dyldInfo.exportEndHex === 'string' && typeof result.dyldInfo.hasExportInfo === 'boolean' && typeof result.dyldInfo.hasAnyBindInfo === 'boolean' && typeof result.dyldInfo.totalRegionCount === 'number' && typeof result.dyldInfo.regionCount === 'number' && typeof result.dyldInfo.hasRegions === 'boolean' && (result.dyldInfo.firstRegionName === null || typeof result.dyldInfo.firstRegionName === 'string') && (result.dyldInfo.lastRegionName === null || typeof result.dyldInfo.lastRegionName === 'string') && (result.dyldInfo.largestRegionName === null || typeof result.dyldInfo.largestRegionName === 'string') && (result.dyldInfo.largestRegionSizeHex === null || typeof result.dyldInfo.largestRegionSizeHex === 'string') && Array.isArray(result.dyldInfo.nonEmptyRegionNames) && Array.isArray(result.dyldInfo.regions) && result.dyldInfo.totalRegionCount === result.dyldInfo.regions.length && typeof result.dyldInfo.totalSizeHex === 'string' && (result.dyldInfo.regions.length === 0 || (typeof result.dyldInfo.regions[0].name === 'string' && typeof result.dyldInfo.regions[0].offsetHex === 'string' && typeof result.dyldInfo.regions[0].sizeHex === 'string' && typeof result.dyldInfo.regions[0].endHex === 'string' && typeof result.dyldInfo.regions[0].hasData === 'boolean' && typeof result.dyldInfo.regions[0].isEmpty === 'boolean')))); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.function_starts', moduleName: main.image.name }); return result.kind === 'native.function_starts' && (result.functionStarts === null || (typeof result.functionStarts.dataoffHex === 'string' && typeof result.functionStarts.dataEnd === 'string' && typeof result.functionStarts.count === 'number' && typeof result.functionStarts.hasStarts === 'boolean' && (result.functionStarts.firstStartOffsetHex === null || typeof result.functionStarts.firstStartOffsetHex === 'string') && (result.functionStarts.firstStartAddress === null || typeof result.functionStarts.firstStartAddress === 'string') && (result.functionStarts.lastStartOffsetHex === null || typeof result.functionStarts.lastStartOffsetHex === 'string') && (result.functionStarts.lastStartAddress === null || typeof result.functionStarts.lastStartAddress === 'string') && typeof result.functionStarts.totalSpanHex === 'string' && typeof result.functionStarts.gapCount === 'number' && typeof result.functionStarts.hasGaps === 'boolean' && (result.functionStarts.firstGapHex === null || typeof result.functionStarts.firstGapHex === 'string') && (result.functionStarts.lastGapHex === null || typeof result.functionStarts.lastGapHex === 'string') && (result.functionStarts.largestGapHex === null || typeof result.functionStarts.largestGapHex === 'string') && Array.isArray(result.functionStarts.starts))); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.code_signature', moduleName: main.image.name }); return result.kind === 'native.code_signature' && (result.codeSignature === null || (typeof result.codeSignature.dataoffHex === 'string' && typeof result.codeSignature.datasizeHex === 'string' && typeof result.codeSignature.dataEnd === 'string' && typeof result.codeSignature.hasMagic === 'boolean' && typeof result.codeSignature.hasMagicName === 'boolean' && typeof result.codeSignature.knownMagic === 'boolean' && typeof result.codeSignature.magicCategory === 'string' && typeof result.codeSignature.blobKind === 'string' && (result.codeSignature.magicHex === null || typeof result.codeSignature.magicHex === 'string') && (result.codeSignature.lengthHex === null || typeof result.codeSignature.lengthHex === 'string') && typeof result.codeSignature.hasCount === 'boolean' && typeof result.codeSignature.hasData === 'boolean' && typeof result.codeSignature.hasBlobLength === 'boolean' && (result.codeSignature.blobLengthMatchesDataSize === null || typeof result.codeSignature.blobLengthMatchesDataSize === 'boolean') && typeof result.codeSignature.blobLengthRelation === 'string' && typeof result.codeSignature.isSuperBlob === 'boolean' && (result.codeSignature.countMatchesSuperBlob === null || typeof result.codeSignature.countMatchesSuperBlob === 'boolean') && typeof result.codeSignature.isDetachedSignature === 'boolean' && typeof result.codeSignature.isBlobWrapper === 'boolean' && typeof result.codeSignature.isCodeDirectory === 'boolean' && typeof result.codeSignature.isEntitlements === 'boolean')); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.exports_trie', moduleName: main.image.name }); return result.kind === 'native.exports_trie' && (result.exportsTrie === null || (typeof result.exportsTrie.dataoffHex === 'string' && typeof result.exportsTrie.dataEnd === 'string' && typeof result.exportsTrie.count === 'number' && typeof result.exportsTrie.hasEntries === 'boolean' && (result.exportsTrie.firstExportName === null || typeof result.exportsTrie.firstExportName === 'string') && (result.exportsTrie.lastExportName === null || typeof result.exportsTrie.lastExportName === 'string') && typeof result.exportsTrie.reexportCount === 'number' && typeof result.exportsTrie.hasReexports === 'boolean' && typeof result.exportsTrie.stubAndResolverCount === 'number' && typeof result.exportsTrie.hasStubAndResolvers === 'boolean' && typeof result.exportsTrie.weakDefinitionCount === 'number' && typeof result.exportsTrie.hasWeakDefinitions === 'boolean' && Array.isArray(result.exportsTrie.entries))); })()"
                    )
