    ...
    mod tests {
        ...
        fn agent_helpers_route_basic_queries() {
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.install_name', moduleName: main.image.name }); return result.kind === 'native.install_name' && typeof result.hasInstallName === 'boolean' && typeof result.resolved === 'boolean' && typeof result.hasName === 'boolean' && typeof result.hasPath === 'boolean' && typeof result.isTokenPath === 'boolean' && typeof result.usesLoaderPath === 'boolean' && typeof result.usesExecutablePath === 'boolean' && typeof result.usesRpathToken === 'boolean' && typeof result.pathDepth === 'number' && typeof result.hasTimestamp === 'boolean' && typeof result.versionMismatch === 'boolean' && ((result.installName === null && result.hasInstallName === false && result.resolved === false && result.resolvedModuleName === null && result.resolvedName === null && result.resolvedPath === null && result.resolvedPathKind === null && result.hasName === false && result.hasPath === false && result.pathDepth === 0 && result.hasTimestamp === false && result.versionMismatch === false && result.text === '<null>') || (typeof result.installName.path === 'string' && typeof result.installName.name === 'string' && typeof result.installName.hasName === 'boolean' && typeof result.installName.hasPath === 'boolean' && typeof result.installName.pathKind === 'string' && typeof result.installName.isTokenPath === 'boolean' && typeof result.installName.usesLoaderPath === 'boolean' && typeof result.installName.usesExecutablePath === 'boolean' && typeof result.installName.usesRpathToken === 'boolean' && typeof result.installName.pathDepth === 'number' && typeof result.installName.currentVersion === 'string' && typeof result.installName.compatibilityVersion === 'string' && typeof result.installName.hasTimestamp === 'boolean' && typeof result.installName.versionMismatch === 'boolean' && result.hasInstallName === true && result.resolved === true && typeof result.resolvedModuleName === 'string' && typeof result.resolvedName === 'string' && typeof result.resolvedPath === 'string' && typeof result.resolvedPathKind === 'string' && result.resolvedModuleName === result.installName.moduleName && result.resolvedName === result.installName.name && result.resolvedPath === result.installName.path && result.resolvedPathKind === result.installName.pathKind && result.hasName === (result.installName.hasName === true) && result.hasPath === (result.installName.hasPath === true) && result.isTokenPath === (result.installName.isTokenPath === true) && result.usesLoaderPath === (result.installName.usesLoaderPath === true) && result.usesExecutablePath === (result.installName.usesExecutablePath === true) && result.usesRpathToken === (result.installName.usesRpathToken === true) && result.pathDepth === result.installName.pathDepth && result.hasTimestamp === (result.installName.hasTimestamp === true) && result.versionMismatch === (result.installName.versionMismatch === true) && result.text === result.installName.text)); })()"
                    )
