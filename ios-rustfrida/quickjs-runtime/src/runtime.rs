    ...
    mod tests {
        ...
        fn agent_helpers_route_basic_queries() {
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('objc.classInfo NSObject meta'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.class_info', className: 'NSObject', isMetaClass: true }); return value === result.text && typeof result.hasClassInfo === 'boolean' && typeof result.resolved === 'boolean' && ((result.classInfo === null && result.hasClassInfo === false && result.resolved === false && result.resolvedClassName === null && result.resolvedSuperclassName === null && result.resolvedImagePath === null && result.hasSuperclass === false && result.superclassName === null && result.isRootClass === false && result.hasProtocols === false && result.hasProperties === false && result.hasIvars === false && result.hasMethods === false && result.hasImagePath === false && result.imagePath === null && result.protocolCount === 0 && result.totalPropertyCount === 0 && result.totalMethodCount === 0) || (result.classInfo.isMetaClass === true && result.hasClassInfo === true && result.resolved === true && result.resolvedClassName === result.classInfo.className && result.resolvedSuperclassName === result.classInfo.superclassName && result.resolvedImagePath === result.classInfo.imagePath && result.hasSuperclass === (result.classInfo.hasSuperclass === true) && result.superclassName === result.classInfo.superclassName && result.isRootClass === (result.classInfo.isRootClass === true) && result.hasProtocols === (result.classInfo.hasProtocols === true) && result.hasProperties === (result.classInfo.hasProperties === true) && result.hasIvars === (result.classInfo.hasIvars === true) && result.hasMethods === (result.classInfo.hasMethods === true) && result.hasImagePath === (result.classInfo.hasImagePath === true) && result.imagePath === result.classInfo.imagePath && result.protocolCount === result.classInfo.protocolCount && result.totalPropertyCount === result.classInfo.totalPropertyCount && result.totalMethodCount === result.classInfo.totalMethodCount)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('objc.methodImage NSObject init'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.method_image', className: 'NSObject', selectorName: 'init', isClassMethod: false }); return value === result.text && typeof result.hasImagePath === 'boolean' && typeof result.resolved === 'boolean' && ((result.imagePath === null && result.hasImagePath === false && result.resolved === false && result.resolvedClassName === null && result.resolvedSelectorName === null && result.resolvedImagePath === null) || (typeof result.imagePath === 'string' && result.hasImagePath === true && result.resolved === true && result.resolvedClassName === result.className && result.resolvedSelectorName === result.selectorName && result.resolvedImagePath === result.imagePath)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('objc.selectorName 0x0'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.selector_name', selector: '0x0' }); return value === result.text && result.name === null && result.hasName === false && result.resolved === false && result.resolvedSelector === null && result.resolvedName === null; })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('objc.objectClassName 0x0'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.object_class_name', object: '0x0' }); return value === result.text && result.className === null && result.hasClassName === false && result.resolved === false && result.resolvedObject === null && result.resolvedClassName === null; })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('swift.available'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'swift.available' }); return value === result.text && result.available === Swift.available && result.resolved === true && result.resolvedAvailable === result.available; })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const value = __iosRustFridaAgentApi.handle('swift.demangle $s4Demo6methodyyF'); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'swift.demangle', symbol: '$s4Demo6methodyyF' }); return value === result.text && ((result.demangled === null && result.hasDemangled === false && result.resolved === false && result.resolvedInputSymbol === null && result.resolvedDemangled === null && result.resolvedSymbol === null && result.text === '<unavailable>') || (typeof result.demangled === 'string' && result.hasDemangled === true && result.resolved === true && result.resolvedInputSymbol === result.symbol && result.resolvedDemangled === result.demangled && result.resolvedSymbol === result.demangled)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'pac.images', filter: null }); if (!(result.kind === 'pac.images' && result.filter === null && result.hasFilter === false && result.count === result.images.length && typeof result.hasImages === 'boolean' && typeof result.uniqueImageCount === 'number' && typeof result.uniquePathKindCount === 'number' && typeof result.systemImageCount === 'number' && typeof result.appImageCount === 'number' && typeof result.jailbreakImageCount === 'number' && Array.isArray(result.imageNames) && Array.isArray(result.pathKinds))) { return false; } if (result.images.length === 0) { return result.hasImages === false && result.firstImageName === null && result.lastImageName === null && result.firstImagePath === null && result.lastImagePath === null && result.firstPathKind === null && result.lastPathKind === null; } const image = result.images[0]; const imageNameSummary = result.imageNames.length === 0 ? null : result.imageNames[0]; const pathKindSummary = result.pathKinds.length === 0 ? null : result.pathKinds[0]; return result.hasImages === true && typeof result.firstImageName === 'string' && typeof result.lastImageName === 'string' && typeof result.firstImagePath === 'string' && typeof result.lastImagePath === 'string' && typeof result.firstPathKind === 'string' && typeof result.lastPathKind === 'string' && typeof image.path === 'string' && typeof image.hasPath === 'boolean' && typeof image.name === 'string' && typeof image.hasName === 'boolean' && typeof image.directoryPath === 'string' && typeof image.hasDirectoryPath === 'boolean' && typeof image.pathKind === 'string' && typeof image.isSystemPath === 'boolean' && typeof image.isAppPath === 'boolean' && typeof image.isJailbreakPath === 'boolean' && typeof image.sizeHex === 'string' && (imageNameSummary === null || (typeof imageNameSummary.name === 'string' && typeof imageNameSummary.count === 'number' && typeof imageNameSummary.firstPath === 'string' && typeof imageNameSummary.lastPath === 'string')) && (pathKindSummary === null || (typeof pathKindSummary.pathKind === 'string' && typeof pathKindSummary.count === 'number' && typeof pathKindSummary.firstImageName === 'string' && typeof pathKindSummary.lastImageName === 'string')); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.class_info', className: 'NSObject', isMetaClass: true }); return result.kind === 'objc.class_info' && result.className === 'NSObject' && result.isMetaClass === true && typeof result.hasClassInfo === 'boolean' && typeof result.resolved === 'boolean' && ((result.classInfo === null && result.hasClassInfo === false && result.resolved === false && result.resolvedClassName === null && result.resolvedSuperclassName === null && result.resolvedImagePath === null && result.hasSuperclass === false && result.superclassName === null && result.isRootClass === false && result.hasProtocols === false && result.hasProperties === false && result.hasIvars === false && result.hasMethods === false && result.hasImagePath === false && result.imagePath === null && result.protocolCount === 0 && result.totalPropertyCount === 0 && result.totalMethodCount === 0 && result.text === '<null>') || (typeof result.classInfo.classPointer === 'string' && result.classInfo.isMetaClass === true && typeof result.classInfo.instanceSize === 'number' && typeof result.classInfo.protocolCount === 'number' && typeof result.classInfo.totalPropertyCount === 'number' && typeof result.classInfo.totalMethodCount === 'number' && result.hasClassInfo === true && result.resolved === true && result.resolvedClassName === result.classInfo.className && result.resolvedSuperclassName === result.classInfo.superclassName && result.resolvedImagePath === result.classInfo.imagePath && result.hasSuperclass === (result.classInfo.hasSuperclass === true) && result.superclassName === result.classInfo.superclassName && result.isRootClass === (result.classInfo.isRootClass === true) && result.hasProtocols === (result.classInfo.hasProtocols === true) && result.hasProperties === (result.classInfo.hasProperties === true) && result.hasIvars === (result.classInfo.hasIvars === true) && result.hasMethods === (result.classInfo.hasMethods === true) && result.hasImagePath === (result.classInfo.hasImagePath === true) && result.imagePath === result.classInfo.imagePath && result.protocolCount === result.classInfo.protocolCount && result.totalPropertyCount === result.classInfo.totalPropertyCount && result.totalMethodCount === result.classInfo.totalMethodCount && result.text === result.classInfo.text)); })()"
                    )
                        ...
                        "(function() {
                            ...
                            if (result.classInfo === null) {
                                if (result.hasClassInfo !== false ||
                                    ...
                                    result.resolvedImagePath === result.classInfo.imagePath &&
                        ...
                        "(function() {
                            ...
                            if (result.protocolInfo === null) {
                                if (result.hasProtocolInfo !== false ||
                                    ...
                                    result.resolvedImagePath === result.protocolInfo.imagePath &&
                ...
                runtime
                    .eval(
                        "(function() {
                            ...
                            if (result.count !== result.methods.length || typeof result.hasMethods !== 'boolean' || typeof result.hasProtocolInfo !== 'boolean' || typeof result.resolved !== 'boolean') {
                                return false;
                            }
                ...
                runtime
                    .eval(
                        "(function() {
                            ...
                            if (result.count !== result.properties.length || typeof result.hasProperties !== 'boolean' || typeof result.hasProtocolInfo !== 'boolean' || typeof result.resolved !== 'boolean') {
                                return false;
                            }
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.class_image', className: 'NSObject' }); return result.kind === 'objc.class_image' && result.className === 'NSObject' && typeof result.hasImagePath === 'boolean' && typeof result.resolved === 'boolean' && ((result.imagePath === null && result.hasImagePath === false && result.resolved === false && result.resolvedClassName === null && result.resolvedImagePath === null && result.text === '<null>') || (typeof result.imagePath === 'string' && result.hasImagePath === true && result.resolved === true && result.resolvedClassName === result.className && result.resolvedImagePath === result.imagePath && result.text === result.imagePath)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.method_image', className: 'NSObject', selectorName: 'init', isClassMethod: false }); return result.kind === 'objc.method_image' && result.className === 'NSObject' && result.selectorName === 'init' && result.isClassMethod === false && typeof result.hasImagePath === 'boolean' && typeof result.resolved === 'boolean' && ((result.imagePath === null && result.hasImagePath === false && result.resolved === false && result.resolvedClassName === null && result.resolvedSelectorName === null && result.resolvedImagePath === null && result.text === '<null>') || (typeof result.imagePath === 'string' && result.hasImagePath === true && result.resolved === true && result.resolvedClassName === result.className && result.resolvedSelectorName === result.selectorName && result.resolvedImagePath === result.imagePath && result.text === result.imagePath)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.method_imp', className: 'NSObject', selectorName: 'init', isClassMethod: false }); return result.kind === 'objc.method_imp' && result.className === 'NSObject' && result.selectorName === 'init' && result.isClassMethod === false && typeof result.hasImp === 'boolean' && typeof result.resolved === 'boolean' && ((result.imp === null && result.hasImp === false && result.resolved === false && result.resolvedClassName === null && result.resolvedSelectorName === null && result.resolvedImp === null && result.text === '<null>') || (typeof result.imp === 'string' && result.hasImp === true && result.resolved === true && result.resolvedClassName === result.className && result.resolvedSelectorName === result.selectorName && result.resolvedImp === result.imp && result.text === result.imp)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.selector_name', selector: '0x0' }); return result.kind === 'objc.selector_name' && result.selector === '0x0' && result.name === null && result.hasName === false && result.resolved === false && result.resolvedSelector === null && result.resolvedName === null && result.text === '<null>'; })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'objc.object_class_name', object: '0x0' }); return result.kind === 'objc.object_class_name' && result.object === '0x0' && result.className === null && result.hasClassName === false && result.resolved === false && result.resolvedObject === null && result.resolvedClassName === null && result.text === '<null>'; })()"
                    )
                ...
                runtime
                    .eval(
                        "(function() {
                            ...
                            if (result.count !== result.ivars.length || typeof result.hasIvars !== 'boolean' || typeof result.hasClassInfo !== 'boolean' || typeof result.resolved !== 'boolean') {
                                return false;
                            }
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.base', moduleName: 'libsystem_malloc.dylib' }); return result.kind === 'native.base' && result.moduleName === 'libsystem_malloc.dylib' && typeof result.hasBase === 'boolean' && typeof result.resolved === 'boolean' && ((result.base === null && result.hasBase === false && result.resolved === false && result.resolvedModuleName === null && result.resolvedBase === null && result.text === '<null>') || (typeof result.base === 'string' && result.hasBase === true && result.resolved === true && result.resolvedModuleName === result.moduleName && result.resolvedBase === result.base && result.text === result.base)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); return result.kind === 'native.main_image' && typeof result.hasImage === 'boolean' && typeof result.resolved === 'boolean' && ((result.image === null && result.hasImage === false && result.resolved === false && result.imageName === null && result.imagePath === null && result.directoryPath === null && result.resolvedImageName === null && result.resolvedImagePath === null && result.resolvedDirectoryPath === null && result.pathKind === null && result.resolvedPathKind === null && result.resolvedBase === null && result.slide === null && result.resolvedSlide === null && result.sizeHex === null && result.resolvedSizeHex === null && result.hasDirectoryPath === false && result.isSystemPath === false && result.isAppPath === false && result.isJailbreakPath === false && result.text === '<null>') || (result.hasImage === true && result.resolved === true && typeof result.imageName === 'string' && typeof result.imagePath === 'string' && typeof result.directoryPath === 'string' && typeof result.resolvedImageName === 'string' && typeof result.resolvedImagePath === 'string' && typeof result.resolvedDirectoryPath === 'string' && typeof result.pathKind === 'string' && typeof result.resolvedPathKind === 'string' && typeof result.resolvedBase === 'string' && typeof result.slide === 'string' && typeof result.resolvedSlide === 'string' && typeof result.sizeHex === 'string' && typeof result.resolvedSizeHex === 'string' && typeof result.hasDirectoryPath === 'boolean' && typeof result.isSystemPath === 'boolean' && typeof result.isAppPath === 'boolean' && typeof result.isJailbreakPath === 'boolean' && typeof result.image.name === 'string' && typeof result.image.path === 'string' && typeof result.image.directoryPath === 'string' && typeof result.image.pathKind === 'string' && typeof result.image.base === 'string' && typeof result.image.slide === 'string' && typeof result.image.sizeHex === 'string' && result.image.name.length !== 0 && result.resolvedImageName === result.image.name && result.resolvedImagePath === result.image.path && result.directoryPath === result.image.directoryPath && result.resolvedDirectoryPath === result.image.directoryPath && result.pathKind === result.image.pathKind && result.resolvedPathKind === result.image.pathKind && result.resolvedBase === result.image.base && result.slide === result.image.slide && result.resolvedSlide === result.image.slide && result.sizeHex === result.image.sizeHex && result.resolvedSizeHex === result.image.sizeHex && result.hasDirectoryPath === (result.image.hasDirectoryPath === true) && result.isSystemPath === (result.image.isSystemPath === true) && result.isAppPath === (result.image.isAppPath === true) && result.isJailbreakPath === (result.image.isJailbreakPath === true) && result.text === result.image.text)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const address = Module.findExportByName(null, 'malloc'); if (address === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.image', address: address.toString() }); return result.kind === 'native.image' && result.address === address.toString() && typeof result.hasImage === 'boolean' && typeof result.resolved === 'boolean' && ((result.image === null && result.hasImage === false && result.resolved === false && result.imageName === null && result.imagePath === null && result.directoryPath === null && result.resolvedImageName === null && result.resolvedImagePath === null && result.resolvedDirectoryPath === null && result.pathKind === null && result.resolvedPathKind === null && result.resolvedBase === null && result.slide === null && result.resolvedSlide === null && result.sizeHex === null && result.resolvedSizeHex === null && result.hasDirectoryPath === false && result.isSystemPath === false && result.isAppPath === false && result.isJailbreakPath === false && result.text === '<null>') || (result.hasImage === true && result.resolved === true && typeof result.imageName === 'string' && typeof result.imagePath === 'string' && typeof result.directoryPath === 'string' && typeof result.resolvedImageName === 'string' && typeof result.resolvedImagePath === 'string' && typeof result.resolvedDirectoryPath === 'string' && typeof result.pathKind === 'string' && typeof result.resolvedPathKind === 'string' && typeof result.resolvedBase === 'string' && typeof result.slide === 'string' && typeof result.resolvedSlide === 'string' && typeof result.sizeHex === 'string' && typeof result.resolvedSizeHex === 'string' && typeof result.hasDirectoryPath === 'boolean' && typeof result.isSystemPath === 'boolean' && typeof result.isAppPath === 'boolean' && typeof result.isJailbreakPath === 'boolean' && typeof result.image.name === 'string' && typeof result.image.path === 'string' && typeof result.image.directoryPath === 'string' && typeof result.image.pathKind === 'string' && typeof result.image.base === 'string' && typeof result.image.slide === 'string' && typeof result.image.sizeHex === 'string' && result.resolvedImageName === result.image.name && result.resolvedImagePath === result.image.path && result.directoryPath === result.image.directoryPath && result.resolvedDirectoryPath === result.image.directoryPath && result.pathKind === result.image.pathKind && result.resolvedPathKind === result.image.pathKind && result.resolvedBase === result.image.base && result.slide === result.image.slide && result.resolvedSlide === result.image.slide && result.sizeHex === result.image.sizeHex && result.resolvedSizeHex === result.image.sizeHex && result.hasDirectoryPath === (result.image.hasDirectoryPath === true) && result.isSystemPath === (result.image.isSystemPath === true) && result.isAppPath === (result.image.isAppPath === true) && result.isJailbreakPath === (result.image.isJailbreakPath === true) && result.text === result.image.text)); })()"
                    )
                    ...
                    .eval(
                        "(function() {
                            ...
                            return result.hasImages === true &&
                                ...
                                typeof result.firstImagePath === 'string' &&
                                typeof result.lastImagePath === 'string' &&
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.image_info', moduleName: 'libsystem_malloc.dylib' }); return result.kind === 'native.image_info' && result.moduleName === 'libsystem_malloc.dylib' && typeof result.hasImage === 'boolean' && typeof result.resolved === 'boolean' && ((result.image === null && result.hasImage === false && result.resolved === false && result.imageName === null && result.imagePath === null && result.directoryPath === null && result.resolvedImageName === null && result.resolvedImagePath === null && result.resolvedDirectoryPath === null && result.pathKind === null && result.resolvedPathKind === null && result.resolvedBase === null && result.slide === null && result.resolvedSlide === null && result.sizeHex === null && result.resolvedSizeHex === null && result.hasDirectoryPath === false && result.isSystemPath === false && result.isAppPath === false && result.isJailbreakPath === false && result.text === '<null>') || (result.hasImage === true && result.resolved === true && typeof result.imageName === 'string' && typeof result.imagePath === 'string' && typeof result.directoryPath === 'string' && typeof result.resolvedImageName === 'string' && typeof result.resolvedImagePath === 'string' && typeof result.resolvedDirectoryPath === 'string' && typeof result.pathKind === 'string' && typeof result.resolvedPathKind === 'string' && typeof result.resolvedBase === 'string' && typeof result.slide === 'string' && typeof result.resolvedSlide === 'string' && typeof result.sizeHex === 'string' && typeof result.resolvedSizeHex === 'string' && typeof result.hasDirectoryPath === 'boolean' && typeof result.isSystemPath === 'boolean' && typeof result.isAppPath === 'boolean' && typeof result.isJailbreakPath === 'boolean' && typeof result.image.name === 'string' && typeof result.image.path === 'string' && typeof result.image.directoryPath === 'string' && typeof result.image.pathKind === 'string' && typeof result.image.base === 'string' && typeof result.image.sizeHex === 'string' && result.resolvedImageName === result.image.name && result.resolvedImagePath === result.image.path && result.directoryPath === result.image.directoryPath && result.resolvedDirectoryPath === result.image.directoryPath && result.pathKind === result.image.pathKind && result.resolvedPathKind === result.image.pathKind && result.resolvedBase === result.image.base && result.slide === result.image.slide && result.resolvedSlide === result.image.slide && result.sizeHex === result.image.sizeHex && result.resolvedSizeHex === result.image.sizeHex && result.hasDirectoryPath === (result.image.hasDirectoryPath === true) && result.isSystemPath === (result.image.isSystemPath === true) && result.isAppPath === (result.image.isAppPath === true) && result.isJailbreakPath === (result.image.isJailbreakPath === true) && result.text === result.image.text)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.dyld_info', moduleName: main.image.name }); return result.kind === 'native.dyld_info' && typeof result.hasDyldInfo === 'boolean' && typeof result.resolved === 'boolean' && typeof result.commandRequiresDyld === 'boolean' && typeof result.totalRegionCount === 'number' && typeof result.regionCount === 'number' && typeof result.hasRegions === 'boolean' && typeof result.hasRebaseInfo === 'boolean' && typeof result.hasBindInfo === 'boolean' && typeof result.hasWeakBindInfo === 'boolean' && typeof result.hasLazyBindInfo === 'boolean' && typeof result.hasExportInfo === 'boolean' && typeof result.hasAnyBindInfo === 'boolean' && Array.isArray(result.nonEmptyRegionNames) && Array.isArray(result.regions) && ((result.dyldInfo === null && result.hasDyldInfo === false && result.resolved === false && result.moduleBase === null && result.commandHex === null && result.commandName === null && result.rebaseOffHex === null && result.rebaseSizeHex === null && result.rebaseEndHex === null && result.bindOffHex === null && result.bindSizeHex === null && result.bindEndHex === null && result.weakBindOffHex === null && result.weakBindSizeHex === null && result.weakBindEndHex === null && result.lazyBindOffHex === null && result.lazyBindSizeHex === null && result.lazyBindEndHex === null && result.exportOffHex === null && result.exportSizeHex === null && result.exportEndHex === null && result.commandRequiresDyld === false && result.totalRegionCount === 0 && result.regionCount === 0 && result.hasRegions === false && result.nonEmptyRegionNames.length === 0 && result.regions.length === 0 && result.hasRebaseInfo === false && result.hasBindInfo === false && result.hasWeakBindInfo === false && result.hasLazyBindInfo === false && result.hasExportInfo === false && result.hasAnyBindInfo === false && result.text === '<null>') || (typeof result.moduleBase === 'string' && typeof result.commandHex === 'string' && typeof result.commandName === 'string' && typeof result.rebaseOffHex === 'string' && typeof result.rebaseSizeHex === 'string' && typeof result.rebaseEndHex === 'string' && typeof result.bindOffHex === 'string' && typeof result.bindSizeHex === 'string' && typeof result.bindEndHex === 'string' && typeof result.weakBindOffHex === 'string' && typeof result.weakBindSizeHex === 'string' && typeof result.weakBindEndHex === 'string' && typeof result.lazyBindOffHex === 'string' && typeof result.lazyBindSizeHex === 'string' && typeof result.lazyBindEndHex === 'string' && typeof result.exportOffHex === 'string' && typeof result.exportSizeHex === 'string' && typeof result.exportEndHex === 'string' && typeof result.dyldInfo.commandName === 'string' && typeof result.dyldInfo.commandRequiresDyld === 'boolean' && typeof result.dyldInfo.rebaseOffHex === 'string' && typeof result.dyldInfo.rebaseEndHex === 'string' && typeof result.dyldInfo.hasRebaseInfo === 'boolean' && typeof result.dyldInfo.bindEndHex === 'string' && typeof result.dyldInfo.hasBindInfo === 'boolean' && typeof result.dyldInfo.weakBindEndHex === 'string' && typeof result.dyldInfo.hasWeakBindInfo === 'boolean' && typeof result.dyldInfo.lazyBindEndHex === 'string' && typeof result.dyldInfo.hasLazyBindInfo === 'boolean' && typeof result.dyldInfo.exportSizeHex === 'string' && typeof result.dyldInfo.exportEndHex === 'string' && typeof result.dyldInfo.hasExportInfo === 'boolean' && typeof result.dyldInfo.hasAnyBindInfo === 'boolean' && typeof result.dyldInfo.totalRegionCount === 'number' && typeof result.dyldInfo.regionCount === 'number' && typeof result.dyldInfo.hasRegions === 'boolean' && result.hasDyldInfo === true && result.resolved === true && result.moduleBase === result.dyldInfo.moduleBase && result.commandHex === result.dyldInfo.commandHex && result.commandName === result.dyldInfo.commandName && result.commandRequiresDyld === (result.dyldInfo.commandRequiresDyld === true) && result.rebaseOffHex === result.dyldInfo.rebaseOffHex && result.rebaseSizeHex === result.dyldInfo.rebaseSizeHex && result.rebaseEndHex === result.dyldInfo.rebaseEndHex && result.bindOffHex === result.dyldInfo.bindOffHex && result.bindSizeHex === result.dyldInfo.bindSizeHex && result.bindEndHex === result.dyldInfo.bindEndHex && result.weakBindOffHex === result.dyldInfo.weakBindOffHex && result.weakBindSizeHex === result.dyldInfo.weakBindSizeHex && result.weakBindEndHex === result.dyldInfo.weakBindEndHex && result.lazyBindOffHex === result.dyldInfo.lazyBindOffHex && result.lazyBindSizeHex === result.dyldInfo.lazyBindSizeHex && result.lazyBindEndHex === result.dyldInfo.lazyBindEndHex && result.exportOffHex === result.dyldInfo.exportOffHex && result.exportSizeHex === result.dyldInfo.exportSizeHex && result.exportEndHex === result.dyldInfo.exportEndHex && result.totalRegionCount === result.dyldInfo.totalRegionCount && result.regionCount === result.dyldInfo.regionCount && result.nonEmptyRegionNames.length === result.dyldInfo.nonEmptyRegionNames.length && result.nonEmptyRegionNames.join('\\n') === result.dyldInfo.nonEmptyRegionNames.join('\\n') && result.regions.length === result.dyldInfo.regions.length && JSON.stringify(result.regions) === JSON.stringify(result.dyldInfo.regions) && result.hasRegions === (result.dyldInfo.hasRegions === true) && result.hasRebaseInfo === (result.dyldInfo.hasRebaseInfo === true) && result.hasBindInfo === (result.dyldInfo.hasBindInfo === true) && result.hasWeakBindInfo === (result.dyldInfo.hasWeakBindInfo === true) && result.hasLazyBindInfo === (result.dyldInfo.hasLazyBindInfo === true) && result.hasExportInfo === (result.dyldInfo.hasExportInfo === true) && result.hasAnyBindInfo === (result.dyldInfo.hasAnyBindInfo === true) && (result.dyldInfo.firstRegionName === null || typeof result.dyldInfo.firstRegionName === 'string') && (result.dyldInfo.lastRegionName === null || typeof result.dyldInfo.lastRegionName === 'string') && (result.dyldInfo.largestRegionName === null || typeof result.dyldInfo.largestRegionName === 'string') && (result.dyldInfo.largestRegionSizeHex === null || typeof result.dyldInfo.largestRegionSizeHex === 'string') && Array.isArray(result.dyldInfo.nonEmptyRegionNames) && Array.isArray(result.dyldInfo.regions) && result.dyldInfo.totalRegionCount === result.dyldInfo.regions.length && typeof result.dyldInfo.totalSizeHex === 'string' && (result.dyldInfo.regions.length === 0 || (typeof result.dyldInfo.regions[0].name === 'string' && typeof result.dyldInfo.regions[0].offsetHex === 'string' && typeof result.dyldInfo.regions[0].sizeHex === 'string' && typeof result.dyldInfo.regions[0].endHex === 'string' && typeof result.dyldInfo.regions[0].hasData === 'boolean' && typeof result.dyldInfo.regions[0].isEmpty === 'boolean')) && result.text === result.dyldInfo.text)); })()"
                    )
                        ...
                        r#"(function() {
                            ...
                            if (result.chainedFixups === null) {
                                return result.hasChainedFixups === false &&
                                    ...
                                    result.linkeditBase === null &&
                                    result.dataAddress === null &&
                                    result.dataEnd === null &&
                                    result.fixupsVersion === null &&
                                    result.startsOffsetHex === null &&
                                    result.importsOffsetHex === null &&
                                    result.symbolsOffsetHex === null &&
                                    result.startsAddress === null &&
                                    result.importsAddress === null &&
                                    result.symbolsAddress === null &&
                                    result.startsBeforeImports === false &&
                                    result.importsBeforeSymbols === false &&
                                    result.offsetsMonotonic === false &&
                                    result.startsToImportsDeltaHex === null &&
                                    result.importsToSymbolsDeltaHex === null &&
                                    result.importsCount === null &&
                                    result.importsFormat === null &&
                                    result.importsFormatName === null &&
                                    result.symbolsFormat === null &&
                                    result.symbolsFormatName === null &&
                                    result.segmentCount === 0 &&
                                    result.hasSegments === false &&
                                    result.firstSegmentIndex === null &&
                                    result.lastSegmentIndex === null &&
                                    ...
                                    result.totalMultiStartPageCount === 0 &&
                                    result.largestSegmentIndex === null &&
                                    result.largestSegmentSizeHex === null &&
                                    result.importCount === 0 &&
                                    result.hasImports === false &&
                                    result.firstImportName === null &&
                                    result.lastImportName === null &&
                            ...
                            if (!(typeof result.hasChainedFixups === 'boolean'
                                ...
                                && result.resolved === true
                                && result.moduleBase === fixups.moduleBase
                                && result.dataoffHex === fixups.dataoffHex
                                && result.datasizeHex === fixups.datasizeHex
                                && result.linkeditBase === fixups.linkeditBase
                                && result.dataAddress === fixups.dataAddress
                                && result.dataEnd === fixups.dataEnd
                                && result.hasData === (fixups.hasData === true)
                                && result.fixupsVersion === fixups.fixupsVersion
                                && result.startsOffsetHex === fixups.startsOffsetHex
                                && result.importsOffsetHex === fixups.importsOffsetHex
                                && result.symbolsOffsetHex === fixups.symbolsOffsetHex
                                && result.startsAddress === fixups.startsAddress
                                && result.importsAddress === fixups.importsAddress
                                && result.symbolsAddress === fixups.symbolsAddress
                                && result.startsBeforeImports === (fixups.startsBeforeImports === true)
                                && result.importsBeforeSymbols === (fixups.importsBeforeSymbols === true)
                                && result.offsetsMonotonic === (fixups.offsetsMonotonic === true)
                                && result.startsToImportsDeltaHex === fixups.startsToImportsDeltaHex
                                && result.importsToSymbolsDeltaHex === fixups.importsToSymbolsDeltaHex
                                && result.importsCount === fixups.importsCount
                                && result.importsFormat === fixups.importsFormat
                                && result.importsFormatName === fixups.importsFormatName
                                && result.symbolsFormat === fixups.symbolsFormat
                                && result.symbolsFormatName === fixups.symbolsFormatName
                                && result.segmentCount === fixups.segmentCount
                                && result.hasSegments === (fixups.hasSegments === true)
                                && result.firstSegmentIndex === fixups.firstSegmentIndex
                                && result.lastSegmentIndex === fixups.lastSegmentIndex
                                ...
                                && result.totalPageCount === fixups.totalPageCount
                                && result.totalFixupPageCount === fixups.totalFixupPageCount
                                && result.totalMultiStartPageCount === fixups.totalMultiStartPageCount
                                && result.totalChainStartCount === fixups.totalChainStartCount
                                && result.largestSegmentIndex === fixups.largestSegmentIndex
                                && result.largestSegmentSizeHex === fixups.largestSegmentSizeHex
                                ...
                                && result.lastImportName === fixups.lastImportName
                                ...
                                && result.uniqueLibOrdinalCount === fixups.uniqueLibOrdinalCount
                                && result.firstLibOrdinal === fixups.firstLibOrdinal
                                && result.lastLibOrdinal === fixups.lastLibOrdinal
                                && Array.isArray(result.libOrdinals)
                    ...
                    .eval(
                        r#"(function() {
                            ...
                            if (dyld.dyldInfo === null) {
                                ...
                                && dyld.moduleBase === dyld.dyldInfo.moduleBase
                                ...
                                && dyld.nonEmptyRegionNames.join('\n') === dyld.dyldInfo.nonEmptyRegionNames.join('\n')
                                && Array.isArray(dyld.regions)
                            ...
                            if (codeSignature.codeSignature === null) {
                                ...
                                && codeSignature.moduleBase === codeSignature.codeSignature.moduleBase
                                ...
                                && codeSignature.magicName === codeSignature.codeSignature.magicName
                            ...
                            if (dataInCode.dataInCode === null) {
                                ...
                                && dataInCode.moduleBase === dataInCode.dataInCode.moduleBase
                            ...
                            if (exportsTrie.exportsTrie === null) {
                                ...
                                && exportsTrie.moduleBase === exportsTrie.exportsTrie.moduleBase
                            ...
                            if (fixups.chainedFixups === null) {
                                return fixups.resolvedModuleName === null
                                    ...
                                    && fixups.moduleBase === null
                                    && fixups.resolvedDataoffHex === null
                                    && fixups.dataoffHex === null
                                    && fixups.resolvedDatasizeHex === null
                                    && fixups.datasizeHex === null
                                    && fixups.resolvedLinkeditBase === null
                                    && fixups.linkeditBase === null
                                    && fixups.resolvedDataAddress === null
                                    && fixups.dataAddress === null
                                    && fixups.resolvedDataEnd === null
                                    && fixups.dataEnd === null
                                    && fixups.hasData === false
                                    && fixups.resolvedFixupsVersion === null
                                    && fixups.fixupsVersion === null
                                    && fixups.resolvedStartsOffsetHex === null
                                    && fixups.startsOffsetHex === null
                                    && fixups.resolvedImportsOffsetHex === null
                                    && fixups.importsOffsetHex === null
                                    && fixups.resolvedSymbolsOffsetHex === null
                                    && fixups.symbolsOffsetHex === null
                                    && fixups.resolvedStartsAddress === null
                                    && fixups.startsAddress === null
                                    && fixups.resolvedImportsAddress === null
                                    && fixups.importsAddress === null
                                    && fixups.resolvedSymbolsAddress === null
                                    && fixups.symbolsAddress === null
                                    && fixups.startsBeforeImports === false
                                    && fixups.importsBeforeSymbols === false
                                    && fixups.offsetsMonotonic === false
                                    && fixups.resolvedStartsToImportsDeltaHex === null
                                    && fixups.startsToImportsDeltaHex === null
                                    && fixups.resolvedImportsToSymbolsDeltaHex === null
                                    && fixups.importsToSymbolsDeltaHex === null
                                    && fixups.resolvedImportsCount === null
                                    && fixups.importsCount === null
                                    && fixups.resolvedImportsFormat === null
                                    && fixups.importsFormat === null
                                    && fixups.resolvedImportsFormatName === null
                                    && fixups.importsFormatName === null
                                    && fixups.resolvedSymbolsFormat === null
                                    ...
                                    && fixups.totalMultiStartPageCount === 0
                                    && fixups.totalChainStartCount === 0
                                    && fixups.resolvedLargestSegmentIndex === null
                            ...
                            return fixups.resolvedModuleName === fixups.chainedFixups.moduleName
                                ...
                                && fixups.moduleBase === fixups.chainedFixups.moduleBase
                                && fixups.resolvedDataoffHex === fixups.chainedFixups.dataoffHex
                                && fixups.dataoffHex === fixups.chainedFixups.dataoffHex
                                && fixups.resolvedDatasizeHex === fixups.chainedFixups.datasizeHex
                                && fixups.datasizeHex === fixups.chainedFixups.datasizeHex
                                && fixups.resolvedLinkeditBase === fixups.chainedFixups.linkeditBase
                                && fixups.linkeditBase === fixups.chainedFixups.linkeditBase
                                && fixups.resolvedDataAddress === fixups.chainedFixups.dataAddress
                                && fixups.dataAddress === fixups.chainedFixups.dataAddress
                                && fixups.resolvedDataEnd === fixups.chainedFixups.dataEnd
                                && fixups.dataEnd === fixups.chainedFixups.dataEnd
                                && fixups.hasData === (fixups.chainedFixups.hasData === true)
                                && fixups.resolvedFixupsVersion === fixups.chainedFixups.fixupsVersion
                                && fixups.fixupsVersion === fixups.chainedFixups.fixupsVersion
                                && fixups.resolvedStartsOffsetHex === fixups.chainedFixups.startsOffsetHex
                                && fixups.startsOffsetHex === fixups.chainedFixups.startsOffsetHex
                                && fixups.resolvedImportsOffsetHex === fixups.chainedFixups.importsOffsetHex
                                && fixups.importsOffsetHex === fixups.chainedFixups.importsOffsetHex
                                && fixups.resolvedSymbolsOffsetHex === fixups.chainedFixups.symbolsOffsetHex
                                && fixups.symbolsOffsetHex === fixups.chainedFixups.symbolsOffsetHex
                                && fixups.resolvedStartsAddress === fixups.chainedFixups.startsAddress
                                && fixups.startsAddress === fixups.chainedFixups.startsAddress
                                && fixups.resolvedImportsAddress === fixups.chainedFixups.importsAddress
                                && fixups.importsAddress === fixups.chainedFixups.importsAddress
                                && fixups.resolvedSymbolsAddress === fixups.chainedFixups.symbolsAddress
                                && fixups.symbolsAddress === fixups.chainedFixups.symbolsAddress
                                && fixups.startsBeforeImports === (fixups.chainedFixups.startsBeforeImports === true)
                                && fixups.importsBeforeSymbols === (fixups.chainedFixups.importsBeforeSymbols === true)
                                && fixups.offsetsMonotonic === (fixups.chainedFixups.offsetsMonotonic === true)
                                && fixups.resolvedStartsToImportsDeltaHex === fixups.chainedFixups.startsToImportsDeltaHex
                                && fixups.startsToImportsDeltaHex === fixups.chainedFixups.startsToImportsDeltaHex
                                && fixups.resolvedImportsToSymbolsDeltaHex === fixups.chainedFixups.importsToSymbolsDeltaHex
                                && fixups.importsToSymbolsDeltaHex === fixups.chainedFixups.importsToSymbolsDeltaHex
                                && fixups.resolvedImportsCount === fixups.chainedFixups.importsCount
                                && fixups.importsCount === fixups.chainedFixups.importsCount
                                && fixups.resolvedImportsFormat === fixups.chainedFixups.importsFormat
                                && fixups.importsFormat === fixups.chainedFixups.importsFormat
                                && fixups.resolvedImportsFormatName === fixups.chainedFixups.importsFormatName
                                && fixups.importsFormatName === fixups.chainedFixups.importsFormatName
                                && fixups.resolvedSymbolsFormat === fixups.chainedFixups.symbolsFormat
                                ...
                                && fixups.totalMultiStartPageCount === fixups.chainedFixups.totalMultiStartPageCount
                                && fixups.totalChainStartCount === fixups.chainedFixups.totalChainStartCount
                                && fixups.resolvedLargestSegmentIndex === fixups.chainedFixups.largestSegmentIndex
                    ...
                    .eval(
                        r#"(function() {
                            function checkImageInfo(result) {
                                ...
                                return result.directoryPath === info.directoryPath
                                    && result.pathKind === info.pathKind
                                    && result.slide === info.slide
                                    && result.sizeHex === info.sizeHex
                                    && result.resolvedDirectoryPath === info.directoryPath
                            ...
                            const mainImageResult = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' });
                            const mallocAddress = Module.findExportByName(null, 'malloc');
                            const imageResult = mallocAddress === null
                                ? { image: null, directoryPath: null, pathKind: null, slide: null, sizeHex: null, resolvedDirectoryPath: null, resolvedPathKind: null, resolvedSlide: null, resolvedSizeHex: null, hasDirectoryPath: false, isSystemPath: false, isAppPath: false, isJailbreakPath: false }
                                : __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.image', address: mallocAddress.toString() });

                            return checkImageInfo(mainImageResult)
                                && checkImageInfo(imageResult)
                                && checkImageInfo(__iosRustFridaAgentApi.handleSpecResult({ kind: 'native.image_info', moduleName: 'libsystem_malloc.dylib' }))
                            ...
                            function checkDylinker(result) {
                                ...
                                if (info === null) {
                                    return result.resolvedModuleBase === null
                                        ...
                                        && result.resolvedIsWeakDylinker === null
                                ...
                                return result.resolvedModuleBase === info.moduleBase
                                    ...
                                    && result.resolvedIsWeakDylinker === info.isWeakDylinker
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.build_version', moduleName: main.image.name }); return result.kind === 'native.build_version' && typeof result.hasBuildVersion === 'boolean' && typeof result.resolved === 'boolean' && typeof result.hasMinOs === 'boolean' && typeof result.hasSdk === 'boolean' && typeof result.minOsPartCount === 'number' && typeof result.sdkPartCount === 'number' && typeof result.hasTools === 'boolean' && typeof result.toolCount === 'number' && typeof result.uniqueToolCount === 'number' && Array.isArray(result.toolNames) && Array.isArray(result.tools) && ((result.buildVersion === null && result.hasBuildVersion === false && result.resolved === false && result.resolvedModuleName === null && result.platform === null && result.hasMinOs === false && result.hasSdk === false && result.hasTools === false && result.firstTool === null && result.lastTool === null && result.firstToolVersion === null && result.lastToolVersion === null && result.toolCount === 0 && result.uniqueToolCount === 0 && result.toolNames.length === 0 && result.tools.length === 0 && result.text === '<null>') || (typeof result.buildVersion.platform === 'string' && typeof result.buildVersion.hasMinOs === 'boolean' && typeof result.buildVersion.hasSdk === 'boolean' && typeof result.buildVersion.minOsPartCount === 'number' && typeof result.buildVersion.sdkPartCount === 'number' && typeof result.buildVersion.hasTools === 'boolean' && (result.buildVersion.firstTool === null || typeof result.buildVersion.firstTool === 'string') && (result.buildVersion.lastTool === null || typeof result.buildVersion.lastTool === 'string') && (result.buildVersion.firstToolVersion === null || typeof result.buildVersion.firstToolVersion === 'string') && (result.buildVersion.lastToolVersion === null || typeof result.buildVersion.lastToolVersion === 'string') && typeof result.buildVersion.uniqueToolCount === 'number' && Array.isArray(result.buildVersion.toolNames) && Array.isArray(result.buildVersion.tools) && result.hasBuildVersion === true && result.resolved === true && typeof result.resolvedModuleName === 'string' && typeof result.platform === 'string' && result.resolvedModuleName === result.buildVersion.moduleName && result.platform === result.buildVersion.platform && result.hasMinOs === (result.buildVersion.hasMinOs === true) && result.hasSdk === (result.buildVersion.hasSdk === true) && result.minOsPartCount === result.buildVersion.minOsPartCount && result.sdkPartCount === result.buildVersion.sdkPartCount && result.hasTools === (result.buildVersion.hasTools === true) && result.firstTool === result.buildVersion.firstTool && result.lastTool === result.buildVersion.lastTool && result.firstToolVersion === result.buildVersion.firstToolVersion && result.lastToolVersion === result.buildVersion.lastToolVersion && result.toolCount === result.buildVersion.tools.length && result.uniqueToolCount === result.buildVersion.uniqueToolCount && result.toolNames.length === result.buildVersion.toolNames.length && result.toolNames.join('\\n') === result.buildVersion.toolNames.join('\\n') && result.tools.length === result.buildVersion.tools.length && JSON.stringify(result.tools) === JSON.stringify(result.buildVersion.tools) && result.text === result.buildVersion.text)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const main = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.main_image' }); if (main.image === null) { return true; } const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.install_name', moduleName: main.image.name }); return result.kind === 'native.install_name' && typeof result.hasInstallName === 'boolean' && typeof result.resolved === 'boolean' && typeof result.hasName === 'boolean' && typeof result.hasPath === 'boolean' && typeof result.isTokenPath === 'boolean' && typeof result.usesLoaderPath === 'boolean' && typeof result.usesExecutablePath === 'boolean' && typeof result.usesRpathToken === 'boolean' && typeof result.pathDepth === 'number' && typeof result.hasTimestamp === 'boolean' && typeof result.versionMismatch === 'boolean' && ((result.installName === null && result.hasInstallName === false && result.resolved === false && result.resolvedModuleName === null && result.resolvedName === null && result.resolvedPath === null && result.resolvedPathKind === null && result.resolvedHasName === null && result.resolvedHasPath === null && result.resolvedIsTokenPath === null && result.resolvedUsesLoaderPath === null && result.resolvedUsesExecutablePath === null && result.resolvedUsesRpathToken === null && result.resolvedPathDepth === 0 && result.resolvedHasTimestamp === null && result.resolvedVersionMismatch === null && result.name === null && result.path === null && result.pathKind === null && result.currentVersion === null && result.compatibilityVersion === null && result.timestamp === null && result.hasName === false && result.hasPath === false && result.pathDepth === 0 && result.hasTimestamp === false && result.versionMismatch === false && result.text === '<null>') || (typeof result.installName.path === 'string' && typeof result.installName.name === 'string' && typeof result.installName.hasName === 'boolean' && typeof result.installName.hasPath === 'boolean' && typeof result.installName.pathKind === 'string' && typeof result.installName.isTokenPath === 'boolean' && typeof result.installName.usesLoaderPath === 'boolean' && typeof result.installName.usesExecutablePath === 'boolean' && typeof result.installName.usesRpathToken === 'boolean' && typeof result.installName.pathDepth === 'number' && typeof result.installName.currentVersion === 'string' && typeof result.installName.compatibilityVersion === 'string' && typeof result.installName.timestamp === 'number' && typeof result.installName.hasTimestamp === 'boolean' && typeof result.installName.versionMismatch === 'boolean' && result.hasInstallName === true && result.resolved === true && typeof result.resolvedModuleName === 'string' && typeof result.resolvedName === 'string' && typeof result.resolvedPath === 'string' && typeof result.resolvedPathKind === 'string' && typeof result.resolvedHasName === 'boolean' && typeof result.resolvedHasPath === 'boolean' && typeof result.resolvedIsTokenPath === 'boolean' && typeof result.resolvedUsesLoaderPath === 'boolean' && typeof result.resolvedUsesExecutablePath === 'boolean' && typeof result.resolvedUsesRpathToken === 'boolean' && typeof result.resolvedPathDepth === 'number' && typeof result.resolvedHasTimestamp === 'boolean' && typeof result.resolvedVersionMismatch === 'boolean' && typeof result.currentVersion === 'string' && typeof result.compatibilityVersion === 'string' && typeof result.timestamp === 'number' && result.resolvedModuleName === result.installName.moduleName && result.resolvedName === result.installName.name && result.resolvedPath === result.installName.path && result.resolvedPathKind === result.installName.pathKind && result.resolvedHasName === (result.installName.hasName === true) && result.resolvedHasPath === (result.installName.hasPath === true) && result.resolvedIsTokenPath === (result.installName.isTokenPath === true) && result.resolvedUsesLoaderPath === (result.installName.usesLoaderPath === true) && result.resolvedUsesExecutablePath === (result.installName.usesExecutablePath === true) && result.resolvedUsesRpathToken === (result.installName.usesRpathToken === true) && result.resolvedPathDepth === result.installName.pathDepth && result.resolvedHasTimestamp === (result.installName.hasTimestamp === true) && result.resolvedVersionMismatch === (result.installName.versionMismatch === true) && result.name === result.installName.name && result.path === result.installName.path && result.pathKind === result.installName.pathKind && result.currentVersion === result.installName.currentVersion && result.compatibilityVersion === result.installName.compatibilityVersion && result.timestamp === result.installName.timestamp && result.hasName === (result.installName.hasName === true) && result.hasPath === (result.installName.hasPath === true) && result.isTokenPath === (result.installName.isTokenPath === true) && result.usesLoaderPath === (result.installName.usesLoaderPath === true) && result.usesExecutablePath === (result.installName.usesExecutablePath === true) && result.usesRpathToken === (result.installName.usesRpathToken === true) && result.pathDepth === result.installName.pathDepth && result.hasTimestamp === (result.installName.hasTimestamp === true) && result.versionMismatch === (result.installName.versionMismatch === true) && result.text === result.installName.text)); })()"
                    )
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() { const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.rpath_info', moduleName: 'libsystem_malloc.dylib', path: '@loader_path' }); return result.kind === 'native.rpath_info' && result.moduleName === 'libsystem_malloc.dylib' && result.path === '@loader_path' && typeof result.hasRpathInfo === 'boolean' && typeof result.resolved === 'boolean' && ((result.rpathInfo === null && result.hasRpathInfo === false && result.resolved === false && result.resolvedPath === null && result.resolvedModuleName === null && result.pathKind === null && result.moduleBase === null && result.text === '<null>') || (typeof result.rpathInfo.moduleBase === 'string' && typeof result.rpathInfo.path === 'string' && result.hasRpathInfo === true && result.resolved === true && typeof result.resolvedPath === 'string' && typeof result.resolvedModuleName === 'string' && typeof result.pathKind === 'string' && typeof result.moduleBase === 'string' && result.resolvedPath === result.rpathInfo.path && result.resolvedModuleName === result.rpathInfo.moduleName && result.pathKind === result.rpathInfo.pathKind && result.moduleBase === result.rpathInfo.moduleBase && result.text === result.rpathInfo.text)); })()"
                    )
                        ...
                        r#"(function() {
                            ...
                            if (result.importNames.length !== 0) {
                                ...
                                if (!(typeof importName.importName === 'string'
                                    ...
                                    && typeof importName.firstNormalizedName === 'string'
                                    && typeof importName.lastNormalizedName === 'string'
                                    && typeof importName.weakImportCount === 'number')) {
                                    return false;
                                }
                            }
            ...
            assert_eq!(
                runtime
                    .eval(
                        r#"(function() {
                            function checkRpathInfo(result) {
                                if (result.rpathInfo === null) {
                                    return result.resolvedPathKind === null
                                        && result.resolvedHasPath === null
                                        && result.resolvedIsTokenPath === null
                                        && result.resolvedUsesLoaderPath === null
                                        && result.resolvedUsesExecutablePath === null
                                ...
                                return result.resolvedPathKind === result.rpathInfo.pathKind
                                    ...
                                    && result.usesRpathToken === (result.rpathInfo.usesRpathToken === true)
                                    && result.pathDepth === result.rpathInfo.pathDepth;
                            }
                            ...
                            function checkLoadCommandInfo(result) {
                                if (result.loadCommandInfo === null) {
                                    return result.resolvedIsReqDyld === null
                                        ...
                                        && result.resolvedUsesExecutablePath === null
                                        && result.resolvedUsesRpathToken === null
                                        && result.resolvedHasCurrentVersion === null
                                        && result.resolvedHasCompatibilityVersion === null
                                        && result.resolvedHasTimestamp === null
                                        && result.resolvedVersionMismatch === null
                                        && result.resolvedHasVersion === null
                                        && result.resolvedHasMinOs === null
                                        ...
                                        && result.resolvedHasUuid === null
                                        && result.resolvedUuidLength === 0
                                        && result.resolvedHasDataRange === null
                                        && result.resolvedHasEntryPoint === null
                                        && result.resolvedHasEncryptedRange === null
                    ...
                    .expect("agent native info resolved summaries"),
                "true"
            );
            assert_eq!(
                runtime
            ...
            assert_eq!(
                runtime
                    .eval(
                        "(function() {
                            const original = Swift.typeLayoutInfo;
                                    ...
                                    witnessTables: [
                                        {
                                            ...
                                            moduleBase: 0x180000000n,
                                            typeName: 'Demo.ViewController',
                                            protocolName: 'Demo.Renderable',
                                            name: '$s4Demo14ViewControllerCAA10RenderableAAWP',
                                            demangledName: 'protocol witness table accessor for Demo.ViewController : Demo.Renderable in Demo',
                                            sourceKind: 'protocol-witness-table-accessor',
                                            address: 0x180007000n,
                                            offset: 0x7000n,
                                            isAccessor: true,
                                        }
                                    ]
                            ...
                            try {
                                ...
                                return result.typeLayout !== null
                                    ...
                                    && result.vtableConstructorCount === 0
                                    && result.vtableAsyncCount === 1
                                    && result.vtableThrowingCount === 1
                                    && result.uniqueVtableMemberKindCount >= 2
                                    && result.witnessAccessorCount === 1
                                    && result.uniqueWitnessProtocolCount === 1
                                    && Array.isArray(result.vtableMemberKinds)
                                    && result.vtableMemberKinds.some((entry) => entry.memberKind === 'getter' && entry.count === 1)
                                    ...
                                    && result.typeLayout.witnessAccessorCount === 1;
                            } finally {
                                Swift.typeLayoutInfo = original;
                            }
                        })()"
                    )
                    .expect("synthetic swift typeLayoutInfo semantics"),
                "true"
            );
            assert_eq!(
                runtime
                    ...
                    .eval(
                        "(function() {
                            ...
                            if (typeof result.uniqueTypeCount !== 'number' ||
                                    typeof result.uniqueMemberCount !== 'number' ||
                                    typeof result.uniqueModuleCount !== 'number' ||
                                    typeof result.uniqueSourceKindCount !== 'number' ||
                            ...
                            const moduleSummary = result.moduleNames.length === 0 ? null : result.moduleNames[0];
                            const memberSummary = result.memberNames.length === 0 ? null : result.memberNames[0];
                            ...
                            return result.hasEntries === true &&
                                ...
                                (memberSummary === null || (
                                    typeof memberSummary.memberName === 'string' &&
                                    typeof memberSummary.count === 'number' &&
                                    typeof memberSummary.firstTypeName === 'string' &&
                                    typeof memberSummary.lastTypeName === 'string' &&
                                    typeof memberSummary.firstModuleName === 'string' &&
                                    typeof memberSummary.lastModuleName === 'string' &&
                                    typeof memberSummary.dispatchThunkCount === 'number' &&
                                    typeof memberSummary.demangledCount === 'number'
                                )) &&
                                (typeSummary === null || (
                                    typeof typeSummary.typeName === 'string' &&
                                    typeof typeSummary.count === 'number' &&
                    ...
                    .eval(
                        r#"(function() {
                            ...
                            return result.hasEntries === true &&
                                ...
                                (witnessKeySummary === null || (
                                    typeof witnessKeySummary.witnessKey === 'string' &&
                                    typeof witnessKeySummary.count === 'number' &&
                                    typeof witnessKeySummary.firstModuleName === 'string' &&
                                    typeof witnessKeySummary.lastModuleName === 'string' &&
                    ...
                    .eval(
                        "(function() {
                            ...
                            if (typeof result.uniqueModuleCount !== 'number' ||
                                    ...
                                    typeof result.vtableAccessorEntryCount !== 'number' ||
                                    typeof result.vtableGetterEntryCount !== 'number' ||
                                    typeof result.vtableSetterEntryCount !== 'number' ||
                                    typeof result.vtableConstructorEntryCount !== 'number' ||
                                    typeof result.vtableDestructorEntryCount !== 'number' ||
                                    typeof result.vtableStaticMemberEntryCount !== 'number' ||
                                    typeof result.vtableAsyncEntryCount !== 'number' ||
                                    typeof result.vtableThrowingEntryCount !== 'number' ||
                                    typeof result.witnessAccessorCount !== 'number' ||
                                    typeof result.layoutsWithAccessorVtableEntriesCount !== 'number' ||
                            ...
                            return result.hasLayouts === true &&
                                ...
                                typeof layout.vtableAccessorCount === 'number' &&
                                typeof layout.vtableGetterCount === 'number' &&
                                typeof layout.vtableSetterCount === 'number' &&
                                typeof layout.vtableConstructorCount === 'number' &&
                                typeof layout.vtableDestructorCount === 'number' &&
                                typeof layout.vtableAsyncCount === 'number' &&
                                typeof layout.vtableThrowingCount === 'number' &&
                                typeof layout.witnessAccessorCount === 'number' &&
                        ...
                        r#"(function() {
                            ...
                            if (typeLayoutInfo.typeLayout === null) {
                                return typeLayoutInfo.resolvedModuleBase === null
                                    ...
                                    && typeLayoutInfo.firstMetadataCacheName === null
                                    && typeLayoutInfo.lastMetadataCacheName === null
                                    && typeLayoutInfo.firstAssociatedTypeDescriptorName === null
                                    && typeLayoutInfo.lastAssociatedTypeDescriptorName === null
                            ...
                            return typeLayoutInfo.resolvedModuleBase === typeLayoutInfo.typeLayout.moduleBase
                                ...
                                && typeLayoutInfo.firstMetadataCacheName === typeLayoutInfo.typeLayout.firstMetadataCacheName
                                && typeLayoutInfo.lastMetadataCacheName === typeLayoutInfo.typeLayout.lastMetadataCacheName
                                && typeLayoutInfo.firstAssociatedTypeDescriptorName === typeLayoutInfo.typeLayout.firstAssociatedTypeDescriptorName
                                && typeLayoutInfo.lastAssociatedTypeDescriptorName === typeLayoutInfo.typeLayout.lastAssociatedTypeDescriptorName
                                ...
                                && typeLayoutInfo.parsedVtableMemberCount === typeLayoutInfo.typeLayout.parsedVtableMemberCount
            ...
            assert_eq!(
                runtime
                    .eval("(function() { const main = __iosRustFridaAgentApi.handle('native.mainImage'); if (main === '<null>') { return true; } const path = main.split(' ').slice(2).join(' '); const base = path.split('/').filter(Boolean).pop() || path; const value = __iosRustFridaAgentApi.handle('native.rpaths ' + base); const result = __iosRustFridaAgentApi.handleSpecResult({ kind: 'native.rpaths', moduleName: base, query: null }); return value === result.text && typeof result.hasImage === 'boolean' && typeof result.resolved === 'boolean'; })()")
