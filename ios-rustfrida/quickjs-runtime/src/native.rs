...
use native_api::{
    ...
    find_image_load_commands, find_image_rpaths, find_image_sections, find_image_segments, find_image_uuid,
    find_native_symbols, hook_environment_recommendations, image_dependency_support_available,
