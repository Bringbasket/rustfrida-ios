...
function normalizeImagePathSummary(pathValue) {
    ...
    return image === null ? null : {
        ...
        hasName: image.hasName,
        hasDirectoryPath: image.hasDirectoryPath,
    };
}
...
function buildModuleImageSummary(image) {
    return {
        ...
        imagePathKind: image === null ? null : image.pathKind,
        base: image === null ? null : image.base,
        ...
        resolvedImagePathKind: image === null ? null : image.pathKind,
...
function normalizeDyldInfo(dyldInfo) {
    ...
    return {
        ...
        nonEmptyRegionList: nonEmptyRegions.map((region) => region.name),
        regions,
...
function normalizeLinkedit(linkedit) {
    ...
    return {
        ...
        tableNameList: tables.map((table) => table.name),
        nonEmptyTableNames: presentTables.map((table) => table.name),
        nonEmptyTableNameList: presentTables.map((table) => table.name),
...
function normalizeBuildVersion(buildVersion) {
    ...
    return {
        ...
        toolNameList: tools.map((tool) => tool.tool),
        tools,
...
function parseLoadCommandDetail(name, detail) {
    ...
    return {
        ...
        nonEmptyDyldRegionList: nonEmptyDyldRegions.map((region) => region.name),
    };
}
...
function normalizeLoadCommand(command) {
    ...
    return {
        ...
        toolNames: parsedDetail.tools.map((tool) => tool.tool),
        toolNameList: parsedDetail.tools.map((tool) => tool.tool),
        ...
        nonEmptyDyldRegionList: parsedDetail.nonEmptyDyldRegionNames,
...
function summarizeSwiftTypeSourceBuckets(buckets) {
    ...
    return {
        ...
        contextModuleNameList: contextModules.map((item) => item.contextModuleName),
        detailKindList: detailKinds.map((item) => item.detailKind),
        sourceKindList: sourceKinds.map((item) => item.sourceKind),
        sourceKinds,
        contextModules,
        detailKinds,
    };
...
function normalizeSwiftTypeLayout(layout) {
    ...
    const normalized = {
        ...
        contextModuleNameList: typeSourceSummary.contextModuleNameList,
        detailKindList: typeSourceSummary.detailKindList,
        sourceKindList: typeSourceSummary.sourceKindList,
...
function handleSpecResult(spec) {
    ...
    case 'objc.class_protocols': {
        ...
        return {
            ...
            resolvedOwnerHasProtocols: normalizedClassInfo === null ? null : normalizedClassInfo.hasProtocols,
            ownerHasProtocols: normalizedClassInfo !== null && normalizedClassInfo.hasProtocols === true,
            resolvedOwnerHasProperties: normalizedClassInfo === null ? null : normalizedClassInfo.hasProperties,
            ownerHasProperties: normalizedClassInfo !== null && normalizedClassInfo.hasProperties === true,
            resolvedOwnerHasMethods: normalizedClassInfo === null ? null : normalizedClassInfo.hasMethods,
            ownerHasMethods: normalizedClassInfo !== null && normalizedClassInfo.hasMethods === true,
            resolvedOwnerTotalPropertyCount: normalizedClassInfo === null ? 0 : normalizedClassInfo.totalPropertyCount,
            ownerTotalPropertyCount: normalizedClassInfo === null ? 0 : normalizedClassInfo.totalPropertyCount,
            resolvedOwnerTotalMethodCount: normalizedClassInfo === null ? 0 : normalizedClassInfo.totalMethodCount,
    ...
    case 'objc.class_info': {
        ...
        return {
            ...
            classPointer: normalized === null ? null : normalized.classPointer,
            resolvedIsMetaClass: normalized === null ? null : normalized.isMetaClass,
            resolvedHasSuperclass: normalized === null ? null : normalized.hasSuperclass,
            hasSuperclass: normalized !== null && normalized.hasSuperclass === true,
            resolvedSuperclassName: normalized === null ? null : normalized.superclassName,
            ...
            superclassPointer: normalized === null ? null : normalized.superclassPointer,
            resolvedIsRootClass: normalized === null ? null : normalized.isRootClass,
            isRootClass: normalized !== null && normalized.isRootClass === true,
            resolvedHasProtocols: normalized === null ? null : normalized.hasProtocols,
            hasProtocols: normalized !== null && normalized.hasProtocols === true,
            resolvedHasInstanceProperties: normalized === null ? null : normalized.hasInstanceProperties,
            hasInstanceProperties: normalized !== null && normalized.hasInstanceProperties === true,
            resolvedHasClassProperties: normalized === null ? null : normalized.hasClassProperties,
            hasClassProperties: normalized !== null && normalized.hasClassProperties === true,
            resolvedHasProperties: normalized === null ? null : normalized.hasProperties,
            hasProperties: normalized !== null && normalized.hasProperties === true,
            resolvedHasIvars: normalized === null ? null : normalized.hasIvars,
            hasIvars: normalized !== null && normalized.hasIvars === true,
            resolvedHasInstanceMethods: normalized === null ? null : normalized.hasInstanceMethods,
            hasInstanceMethods: normalized !== null && normalized.hasInstanceMethods === true,
            resolvedHasClassMethods: normalized === null ? null : normalized.hasClassMethods,
            hasClassMethods: normalized !== null && normalized.hasClassMethods === true,
            resolvedHasMethods: normalized === null ? null : normalized.hasMethods,
            hasMethods: normalized !== null && normalized.hasMethods === true,
            resolvedHasImagePath: normalized === null ? null : normalized.hasImagePath,
            ...
            resolvedInstanceSize: normalized === null ? 0 : normalized.instanceSize,
            instanceSize: normalized === null ? 0 : normalized.instanceSize,
            resolvedProtocolCount: normalized === null ? 0 : normalized.protocolCount,
            protocolCount: normalized === null ? 0 : normalized.protocolCount,
            resolvedInstancePropertyCount: normalized === null ? 0 : normalized.instancePropertyCount,
            instancePropertyCount: normalized === null ? 0 : normalized.instancePropertyCount,
            resolvedClassPropertyCount: normalized === null ? 0 : normalized.classPropertyCount,
            classPropertyCount: normalized === null ? 0 : normalized.classPropertyCount,
            resolvedTotalPropertyCount: normalized === null ? 0 : normalized.totalPropertyCount,
            totalPropertyCount: normalized === null ? 0 : normalized.totalPropertyCount,
            resolvedIvarCount: normalized === null ? 0 : normalized.ivarCount,
            ivarCount: normalized === null ? 0 : normalized.ivarCount,
            resolvedInstanceMethodCount: normalized === null ? 0 : normalized.instanceMethodCount,
            instanceMethodCount: normalized === null ? 0 : normalized.instanceMethodCount,
            resolvedClassMethodCount: normalized === null ? 0 : normalized.classMethodCount,
            classMethodCount: normalized === null ? 0 : normalized.classMethodCount,
            resolvedTotalMethodCount: normalized === null ? 0 : normalized.totalMethodCount,
    ...
    case 'objc.protocol_info': {
        ...
        return {
            ...
            protocolPointer: normalized === null ? null : normalized.protocolPointer,
            resolvedAdoptedProtocolNames: normalized === null ? [] : normalized.adoptedProtocols,
            adoptedProtocolNames: normalized === null ? [] : normalized.adoptedProtocols,
            resolvedFirstAdoptedProtocol: normalized === null || normalized.adoptedProtocolCount === 0
                ? null
                : normalized.adoptedProtocols[0],
            firstAdoptedProtocol: normalized === null || normalized.adoptedProtocolCount === 0
                ? null
                : normalized.adoptedProtocols[0],
            resolvedLastAdoptedProtocol: normalized === null || normalized.adoptedProtocolCount === 0
                ? null
                : normalized.adoptedProtocols[normalized.adoptedProtocolCount - 1],
            lastAdoptedProtocol: normalized === null || normalized.adoptedProtocolCount === 0
                ? null
                : normalized.adoptedProtocols[normalized.adoptedProtocolCount - 1],
            resolvedHasAdoptedProtocols: normalized === null ? null : normalized.hasAdoptedProtocols,
            hasAdoptedProtocols: normalized !== null && normalized.hasAdoptedProtocols === true,
            resolvedHasRequiredMethods: normalized === null ? null : normalized.hasRequiredMethods,
            hasRequiredMethods: normalized !== null && normalized.hasRequiredMethods === true,
            resolvedHasOptionalMethods: normalized === null ? null : normalized.hasOptionalMethods,
            ...
            resolvedImagePathKind: imageSummary === null ? null : imageSummary.pathKind,
            imagePathKind: imageSummary === null ? null : imageSummary.pathKind,
            resolvedAdoptedProtocolCount: normalized === null ? 0 : normalized.adoptedProtocolCount,
            adoptedProtocolCount: normalized === null ? 0 : normalized.adoptedProtocolCount,
            resolvedRequiredInstanceMethodCount: normalized === null ? 0 : normalized.requiredInstanceMethodCount,
            requiredInstanceMethodCount: normalized === null ? 0 : normalized.requiredInstanceMethodCount,
            resolvedRequiredClassMethodCount: normalized === null ? 0 : normalized.requiredClassMethodCount,
            requiredClassMethodCount: normalized === null ? 0 : normalized.requiredClassMethodCount,
            resolvedOptionalInstanceMethodCount: normalized === null ? 0 : normalized.optionalInstanceMethodCount,
            optionalInstanceMethodCount: normalized === null ? 0 : normalized.optionalInstanceMethodCount,
            resolvedOptionalClassMethodCount: normalized === null ? 0 : normalized.optionalClassMethodCount,
            optionalClassMethodCount: normalized === null ? 0 : normalized.optionalClassMethodCount,
            resolvedTotalMethodCount: normalized === null ? 0 : normalized.totalMethodCount,
            totalMethodCount: normalized === null ? 0 : normalized.totalMethodCount,
            resolvedPropertyCount: normalized === null ? 0 : normalized.propertyCount,
    ...
    case 'objc.protocol_methods': {
        ...
        return {
            ...
            selectorNameList: summary.selectors.map((item) => item.selector),
            returnTypeNameList: summary.returnTypes.map((item) => item.returnTypeName),
            selectorNames: summary.selectors.map((item) => item.selector),
            returnTypeNames: summary.returnTypes.map((item) => item.returnTypeName),
    ...
    case 'objc.protocol_method_info': {
        ...
        return {
            ...
            typeEncoding: normalized === null ? null : normalized.typeEncoding,
            resolvedReturnTypeName: normalized === null ? null : normalized.returnTypeName,
            returnTypeName: normalized === null ? null : normalized.returnTypeName,
            ...
            resolvedHiddenArgumentCount: normalized === null ? 0 : normalized.hiddenArgumentCount,
            hiddenArgumentCount: normalized === null ? 0 : normalized.hiddenArgumentCount,
            resolvedSelectorPartCount: normalized === null ? 0 : normalized.selectorPartCount,
            selectorPartCount: normalized === null ? 0 : normalized.selectorPartCount,
            resolvedHasImagePath: normalized === null ? null : normalized.imagePath !== null,
            hasImagePath: normalized !== null && normalized.imagePath !== null,
            resolvedHasSelectorArguments: normalized === null ? null : normalized.hasSelectorArguments,
            hasSelectorArguments: normalized !== null && normalized.hasSelectorArguments === true,
            resolvedIsUnarySelector: normalized === null ? null : normalized.isUnarySelector,
            isUnarySelector: normalized !== null && normalized.isUnarySelector === true,
            resolvedIsKeywordSelector: normalized === null ? null : normalized.isKeywordSelector,
            isKeywordSelector: normalized !== null && normalized.isKeywordSelector === true,
            resolvedHasExplicitArguments: normalized === null ? null : normalized.hasExplicitArguments,
            hasExplicitArguments: normalized !== null && normalized.hasExplicitArguments === true,
            resolvedHasHiddenArguments: normalized === null ? null : normalized.hasHiddenArguments,
            hasHiddenArguments: normalized !== null && normalized.hasHiddenArguments === true,
            resolvedReturnsVoid: normalized === null ? null : normalized.returnsVoid,
            returnsVoid: normalized !== null && normalized.returnsVoid === true,
            resolvedReturnsObject: normalized === null ? null : normalized.returnsObject,
            returnsObject: normalized !== null && normalized.returnsObject === true,
            resolvedReturnsBlock: normalized === null ? null : normalized.returnsBlock,
    ...
    case 'objc.protocol_properties': {
        ...
        return {
            ...
            ownershipNameList: summary.ownerships.map((item) => item.ownership),
            objectClassNameList: summary.objectClasses.map((item) => item.objectClassName),
            ownershipNames: summary.ownerships.map((item) => item.ownership),
            objectClassNames: summary.objectClasses.map((item) => item.objectClassName),
    ...
    case 'objc.protocol_property_info': {
        ...
        return {
            ...
            propertyPointer: normalized === null ? null : normalized.propertyPointer,
            ...
            resolvedObjectProtocolCount: normalized === null ? 0 : normalized.objectProtocolCount,
            objectProtocolCount: normalized === null ? 0 : normalized.objectProtocolCount,
            resolvedParsedTokenCount: normalized === null ? 0 : normalized.parsedTokenCount,
            parsedTokenCount: normalized === null ? 0 : normalized.parsedTokenCount,
            resolvedHasAccessorCustomization: normalized === null ? null : normalized.hasAccessorCustomization,
            hasAccessorCustomization: normalized !== null && normalized.hasAccessorCustomization === true,
            resolvedHasGetterName: normalized === null ? null : normalized.hasGetterName,
            hasGetterName: normalized !== null && normalized.hasGetterName === true,
            resolvedHasSetterName: normalized === null ? null : normalized.hasSetterName,
            hasSetterName: normalized !== null && normalized.hasSetterName === true,
            resolvedHasBackingIvar: normalized === null ? null : normalized.hasBackingIvar,
            hasBackingIvar: normalized !== null && normalized.hasBackingIvar === true,
            resolvedHasObjectClassName: normalized === null ? null : normalized.hasObjectClassName,
            hasObjectClassName: normalized !== null && normalized.hasObjectClassName === true,
            resolvedHasObjectProtocols: normalized === null ? null : normalized.hasObjectProtocols,
            hasObjectProtocols: normalized !== null && normalized.hasObjectProtocols === true,
            resolvedHasTypeInfo: normalized === null ? null : normalized.hasTypeInfo,
            hasTypeInfo: normalized !== null && normalized.hasTypeInfo === true,
            resolvedIsObject: normalized === null ? null : normalized.isObject,
            isObject: normalized !== null && normalized.isObject === true,
            resolvedIsBlock: normalized === null ? null : normalized.isBlock,
    ...
    case 'objc.method_info': {
        ...
        return {
            ...
            methodPointer: normalized === null ? null : normalized.methodPointer,
            resolvedImp: normalized === null ? null : normalized.imp,
            imp: normalized === null ? null : normalized.imp,
            resolvedTypeEncoding: normalized === null ? null : normalized.typeEncoding,
            typeEncoding: normalized === null ? null : normalized.typeEncoding,
            resolvedReturnTypeName: normalized === null ? null : normalized.returnTypeName,
            returnTypeName: normalized === null ? null : normalized.returnTypeName,
    ...
    case 'objc.methods': {
        ...
        return {
            ...
            resolvedOwnerHasProperties: normalizedClassInfo === null ? null : normalizedClassInfo.hasProperties,
            ownerHasProperties: normalizedClassInfo !== null && normalizedClassInfo.hasProperties === true,
            resolvedOwnerHasIvars: normalizedClassInfo === null ? null : normalizedClassInfo.hasIvars,
            ownerHasIvars: normalizedClassInfo !== null && normalizedClassInfo.hasIvars === true,
            resolvedOwnerHasMethods: normalizedClassInfo === null ? null : normalizedClassInfo.hasMethods,
            ownerHasMethods: normalizedClassInfo !== null && normalizedClassInfo.hasMethods === true,
            resolvedOwnerIvarCount: normalizedClassInfo === null ? 0 : normalizedClassInfo.ivarCount,
    ...
    case 'objc.ivars': {
        ...
        return {
            ...
            kindNameList: summary.kinds.map((item) => item.kind),
            objectClassNameList: summary.objectClasses.map((item) => item.objectClassName),
            kindNames: summary.kinds.map((item) => item.kind),
            objectClassNames: summary.objectClasses.map((item) => item.objectClassName),
            kinds: summary.kinds,
            objectClasses: summary.objectClasses,
            ivars,
    ...
    case 'objc.ivar_info': {
        ...
        return {
            ...
            ivarPointer: normalized === null ? null : normalized.ivarPointer,
            resolvedOffset: normalized === null ? null : normalized.offset,
            offset: normalized === null ? null : normalized.offset,
            ...
            resolvedObjectClassName: normalized === null ? null : normalized.objectClassName,
            resolvedObjectProtocols: normalized === null ? [] : normalized.objectProtocols,
            objectProtocols: normalized === null ? [] : normalized.objectProtocols,
            resolvedMemberName: normalized === null ? null : normalized.memberName,
            resolvedPointeeTypeName: normalized === null ? null : normalized.pointeeTypeName,
            typeName: normalized === null ? null : normalized.typeName,
            kindName: normalized === null ? null : normalized.kind,
            objectClassName: normalized === null ? null : normalized.objectClassName,
            pointeeTypeName: normalized === null ? null : normalized.pointeeTypeName,
            resolvedObjectProtocolCount: normalized === null ? 0 : normalized.objectProtocolCount,
            objectProtocolCount: normalized === null ? 0 : normalized.objectProtocolCount,
            resolvedArrayCount: normalized === null ? null : normalized.arrayCount,
            arrayCount: normalized === null ? null : normalized.arrayCount,
            resolvedQualifierNames: normalized === null ? [] : normalized.qualifierNames,
            qualifierNames: normalized === null ? [] : normalized.qualifierNames,
            resolvedQualifierNameList: normalized === null ? [] : normalized.qualifierNameList,
            qualifierNameList: normalized === null ? [] : normalized.qualifierNameList,
            resolvedQualifierCount: normalized === null ? 0 : normalized.qualifierCount,
            qualifierCount: normalized === null ? 0 : normalized.qualifierCount,
            resolvedHasQualifiers: normalized === null ? null : normalized.hasQualifiers,
            hasQualifiers: normalized !== null && normalized.hasQualifiers === true,
            resolvedHasObjectClassName: normalized === null ? null : normalized.hasObjectClassName,
            hasObjectClassName: normalized !== null && normalized.hasObjectClassName === true,
            resolvedHasObjectProtocols: normalized === null ? null : normalized.objectProtocolCount !== 0,
            hasObjectProtocols: normalized !== null && normalized.objectProtocolCount !== 0,
            resolvedHasPointeeType: normalized === null ? null : normalized.hasPointeeType,
            hasPointeeType: normalized !== null && normalized.hasPointeeType === true,
            resolvedIsObject: normalized === null ? null : normalized.isObject,
            isObject: normalized !== null && normalized.isObject === true,
            resolvedIsBlock: normalized === null ? null : normalized.isBlock,
            isBlock: normalized !== null && normalized.isBlock === true,
            resolvedIsPointer: normalized === null ? null : normalized.isPointer,
            isPointer: normalized !== null && normalized.isPointer === true,
            resolvedIsArray: normalized === null ? null : normalized.isArray,
            isArray: normalized !== null && normalized.isArray === true,
            memberName: normalized === null ? null : normalized.memberName,
            resolvedHasMemberName: normalized === null ? null : normalized.hasMemberName,
    ...
    case 'native.images': {
        ...
        return {
            ...
            appImageCount,
            jailbreakImageCount,
            imageNameList: imageNames.map((item) => item.name),
            pathKindList: pathKinds.map((item) => item.pathKind),
            imageNames,
            pathKinds,
            images,
    ...
    case 'native.image_info': {
        ...
        return {
            ...
            base: normalized === null ? null : normalized.base,
    ...
    case 'native.export': {
        ...
        return {
            ...
            name: symbol === null ? null : symbol.name,
    ...
    case 'native.symbols': {
        ...
        return {
            ...
            symbolNameList: symbolNames.map((item) => item.symbolName),
    ...
    case 'native.dependencies': {
        ...
        return {
            ...
            pathKindList: pathKindSummaries.map((item) => item.pathKind),
            kindNames: kindSummaries.map((item) => item.kind),
            kindList: kindSummaries.map((item) => item.kind),
            dependencyNameList: dependencyNames.map((item) => item.dependencyName),
    ...
    case 'native.dependency_info': {
        ...
        return {
            ...
            resolvedHasPath: normalized === null ? null : normalized.hasPath,
            resolvedIsTokenPath: normalized === null ? null : normalized.isTokenPath,
            resolvedPathDepth: normalized === null ? 0 : normalized.pathDepth,
            name: normalized === null ? null : normalized.name,
    ...
    case 'native.dyld_info': {
        ...
        return {
            ...
            nonEmptyRegionList: normalized === null ? [] : normalized.nonEmptyRegionList,
    ...
    case 'native.linkedit': {
        ...
        return {
            ...
            tableNameList: normalized === null ? [] : normalized.tableNameList,
            nonEmptyTableNames: normalized === null ? [] : normalized.nonEmptyTableNames,
            nonEmptyTableNameList: normalized === null ? [] : normalized.nonEmptyTableNameList,
    ...
    case 'native.function_starts': {
        ...
        return {
            ...
            resolvedLinkeditBase: normalized === null ? null : normalized.linkeditBase,
            ...
            resolvedFirstStartOffsetHex: normalized === null ? null : normalized.firstStartOffsetHex,
            firstStartOffsetHex: normalized === null ? null : normalized.firstStartOffsetHex,
            resolvedFirstStartAddress: normalized === null ? null : normalized.firstStartAddress,
            firstStartAddress: normalized === null ? null : normalized.firstStartAddress,
            resolvedLastStartOffsetHex: normalized === null ? null : normalized.lastStartOffsetHex,
            lastStartOffsetHex: normalized === null ? null : normalized.lastStartOffsetHex,
            resolvedLastStartAddress: normalized === null ? null : normalized.lastStartAddress,
            lastStartAddress: normalized === null ? null : normalized.lastStartAddress,
            resolvedTotalSpanHex: normalized === null ? null : normalized.totalSpanHex,
            ...
            resolvedFirstGapHex: normalized === null ? null : normalized.firstGapHex,
            firstGapHex: normalized === null ? null : normalized.firstGapHex,
            resolvedLastGapHex: normalized === null ? null : normalized.lastGapHex,
            lastGapHex: normalized === null ? null : normalized.lastGapHex,
            resolvedFirstGapFromOffsetHex: normalized === null ? null : normalized.firstGapFromOffsetHex,
            firstGapFromOffsetHex: normalized === null ? null : normalized.firstGapFromOffsetHex,
            resolvedFirstGapToOffsetHex: normalized === null ? null : normalized.firstGapToOffsetHex,
            firstGapToOffsetHex: normalized === null ? null : normalized.firstGapToOffsetHex,
            resolvedLastGapFromOffsetHex: normalized === null ? null : normalized.lastGapFromOffsetHex,
            lastGapFromOffsetHex: normalized === null ? null : normalized.lastGapFromOffsetHex,
            resolvedLastGapToOffsetHex: normalized === null ? null : normalized.lastGapToOffsetHex,
    ...
    case 'native.code_signature': {
        ...
        return {
            ...
            resolvedDataEnd: normalized === null ? null : normalized.dataEnd,
            dataEnd: normalized === null ? null : normalized.dataEnd,
            resolvedBlobKind: normalized === null ? null : normalized.blobKind,
            blobKind: normalized === null ? null : normalized.blobKind,
            resolvedMagicCategory: normalized === null ? null : normalized.magicCategory,
            ...
            resolvedKnownMagic: normalized === null ? null : normalized.knownMagic,
            knownMagic: normalized !== null && normalized.knownMagic === true,
            resolvedHasCount: normalized === null ? null : normalized.hasCount,
            hasCount: normalized !== null && normalized.hasCount === true,
            resolvedHasBlobLength: normalized === null ? null : normalized.hasBlobLength,
            hasBlobLength: normalized !== null && normalized.hasBlobLength === true,
            resolvedBlobLengthMatchesDataSize: normalized === null ? null : normalized.blobLengthMatchesDataSize,
            blobLengthMatchesDataSize: normalized === null ? null : normalized.blobLengthMatchesDataSize,
            resolvedBlobLengthRelation: normalized === null ? null : normalized.blobLengthRelation,
            blobLengthRelation: normalized === null ? null : normalized.blobLengthRelation,
            resolvedCountMatchesSuperBlob: normalized === null ? null : normalized.countMatchesSuperBlob,
    ...
    case 'native.data_in_code': {
        ...
        return {
            ...
            resolvedDataEnd: normalized === null ? null : normalized.dataEnd,
            dataEnd: normalized === null ? null : normalized.dataEnd,
            resolvedHasData: normalized === null ? null : normalized.hasData,
            hasData: normalized !== null && normalized.hasData === true,
            entryCount: normalized === null ? 0 : normalized.count,
            hasEntries: normalized !== null && normalized.hasEntries === true,
            resolvedTotalEntryLength: normalized === null ? null : normalized.totalEntryLength,
            totalEntryLength: normalized === null ? null : normalized.totalEntryLength,
            resolvedFirstEntryOffsetHex: normalized === null ? null : normalized.firstEntryOffsetHex,
            firstEntryOffsetHex: normalized === null ? null : normalized.firstEntryOffsetHex,
            resolvedFirstEntryAddress: normalized === null ? null : normalized.firstEntryAddress,
            firstEntryAddress: normalized === null ? null : normalized.firstEntryAddress,
            resolvedFirstKindName: normalized === null ? null : normalized.firstKindName,
            firstKindName: normalized === null ? null : normalized.firstKindName,
            resolvedLastEntryOffsetHex: normalized === null ? null : normalized.lastEntryOffsetHex,
            lastEntryOffsetHex: normalized === null ? null : normalized.lastEntryOffsetHex,
            resolvedLastEntryAddress: normalized === null ? null : normalized.lastEntryAddress,
            lastEntryAddress: normalized === null ? null : normalized.lastEntryAddress,
            resolvedLastKindName: normalized === null ? null : normalized.lastKindName,
            lastKindName: normalized === null ? null : normalized.lastKindName,
            resolvedLargestEntryOffsetHex: normalized === null ? null : normalized.largestEntryOffsetHex,
            largestEntryOffsetHex: normalized === null ? null : normalized.largestEntryOffsetHex,
            resolvedLargestEntryAddress: normalized === null ? null : normalized.largestEntryAddress,
            largestEntryAddress: normalized === null ? null : normalized.largestEntryAddress,
            resolvedLargestEntryLength: normalized === null ? null : normalized.largestEntryLength,
    ...
    case 'native.exports_trie': {
        ...
        return {
            ...
            entryCount: normalized === null ? 0 : normalized.count,
            hasEntries: normalized !== null && normalized.hasEntries === true,
            resolvedFirstExportName: normalized === null ? null : normalized.firstExportName,
            firstExportName: normalized === null ? null : normalized.firstExportName,
            resolvedFirstKind: normalized === null ? null : normalized.firstKind,
            firstKind: normalized === null ? null : normalized.firstKind,
            resolvedLastExportName: normalized === null ? null : normalized.lastExportName,
            lastExportName: normalized === null ? null : normalized.lastExportName,
            resolvedLastKind: normalized === null ? null : normalized.lastKind,
            lastKind: normalized === null ? null : normalized.lastKind,
            resolvedLongestExportName: normalized === null ? null : normalized.longestExportName,
            longestExportName: normalized === null ? null : normalized.longestExportName,
            resolvedLongestExportNameLength: normalized === null ? null : normalized.longestExportNameLength,
            longestExportNameLength: normalized === null ? null : normalized.longestExportNameLength,
            resolvedAddressSpanHex: normalized === null ? null : normalized.addressSpanHex,
            addressSpanHex: normalized === null ? null : normalized.addressSpanHex,
            resolvedOffsetSpanHex: normalized === null ? null : normalized.offsetSpanHex,
            offsetSpanHex: normalized === null ? null : normalized.offsetSpanHex,
            uniqueKindCount: normalized === null ? 0 : normalized.uniqueKindCount,
            hasMultipleKinds: normalized !== null && normalized.hasMultipleKinds === true,
            resolvedAddressEntryCount: normalized === null ? 0 : normalized.addressEntryCount,
            ...
            resolvedLowestAddress: normalized === null ? null : normalized.lowestAddress,
            lowestAddress: normalized === null ? null : normalized.lowestAddress,
            resolvedHighestAddress: normalized === null ? null : normalized.highestAddress,
            highestAddress: normalized === null ? null : normalized.highestAddress,
            resolvedOffsetEntryCount: normalized === null ? 0 : normalized.offsetEntryCount,
            ...
            resolvedLowestOffsetHex: normalized === null ? null : normalized.lowestOffsetHex,
            lowestOffsetHex: normalized === null ? null : normalized.lowestOffsetHex,
            resolvedHighestOffsetHex: normalized === null ? null : normalized.highestOffsetHex,
            highestOffsetHex: normalized === null ? null : normalized.highestOffsetHex,
            resolvedImportNameCount: normalized === null ? 0 : normalized.importNameCount,
            ...
            resolvedWeakDefinitionCount: normalized === null ? 0 : normalized.weakDefinitionCount,
    ...
    case 'native.chained_fixups': {
        ...
        return {
            ...
            dataEnd: normalized === null ? null : normalized.dataEnd,
            hasData: normalized !== null && normalized.hasData === true,
            resolvedFixupsVersion: normalized === null ? null : normalized.fixupsVersion,
            ...
            resolvedStartsToImportsDeltaHex: normalized === null ? null : normalized.startsToImportsDeltaHex,
            startsToImportsDeltaHex: normalized === null ? null : normalized.startsToImportsDeltaHex,
            resolvedImportsToSymbolsDeltaHex: normalized === null ? null : normalized.importsToSymbolsDeltaHex,
            importsToSymbolsDeltaHex: normalized === null ? null : normalized.importsToSymbolsDeltaHex,
            resolvedImportsCount: normalized === null ? null : normalized.importsCount,
            importsCount: normalized === null ? null : normalized.importsCount,
            resolvedImportsFormat: normalized === null ? null : normalized.importsFormat,
            importsFormat: normalized === null ? null : normalized.importsFormat,
            resolvedImportsFormatName: normalized === null ? null : normalized.importsFormatName,
            importsFormatName: normalized === null ? null : normalized.importsFormatName,
            resolvedSymbolsFormat: normalized === null ? null : normalized.symbolsFormat,
            symbolsFormat: normalized === null ? null : normalized.symbolsFormat,
            resolvedSymbolsFormatName: normalized === null ? null : normalized.symbolsFormatName,
            ...
            resolvedFirstSegmentIndex: normalized === null ? null : normalized.firstSegmentIndex,
            firstSegmentIndex: normalized === null ? null : normalized.firstSegmentIndex,
            resolvedLastSegmentIndex: normalized === null ? null : normalized.lastSegmentIndex,
            ...
            resolvedTotalMultiStartPageCount: normalized === null ? 0 : normalized.totalMultiStartPageCount,
            ...
            resolvedLargestSegmentIndex: normalized === null ? null : normalized.largestSegmentIndex,
            largestSegmentIndex: normalized === null ? null : normalized.largestSegmentIndex,
            resolvedLargestSegmentSizeHex: normalized === null ? null : normalized.largestSegmentSizeHex,
            ...
            resolvedLastImportName: normalized === null ? null : normalized.lastImportName,
            ...
            resolvedFirstLibOrdinal: normalized === null ? null : normalized.firstLibOrdinal,
    ...
    case 'native.source_version': {
        ...
        return {
            ...
            resolvedHasVersion: normalized === null ? null : normalized.hasVersion,
            hasVersion: normalized !== null && normalized.hasVersion === true,
            resolvedVersionPartCount: normalized === null ? 0 : normalized.versionPartCount,
            versionPartCount: normalized === null ? 0 : normalized.versionPartCount,
            resolvedMajorVersion: normalized === null ? null : normalized.majorVersion,
            majorVersion: normalized === null ? null : normalized.majorVersion,
            resolvedMinorVersion: normalized === null ? null : normalized.minorVersion,
            minorVersion: normalized === null ? null : normalized.minorVersion,
            resolvedPatchVersion: normalized === null ? null : normalized.patchVersion,
            patchVersion: normalized === null ? null : normalized.patchVersion,
            resolvedExtraVersionCount: normalized === null ? 0 : normalized.extraVersionCount,
    ...
    case 'native.build_version': {
        ...
        return {
            ...
            resolvedMinOsPartCount: normalized === null ? 0 : normalized.minOsPartCount,
            minOsPartCount: normalized === null ? 0 : normalized.minOsPartCount,
            resolvedSdkPartCount: normalized === null ? 0 : normalized.sdkPartCount,
            sdkPartCount: normalized === null ? 0 : normalized.sdkPartCount,
            resolvedHasTools: normalized === null ? null : normalized.hasTools,
            hasTools: normalized !== null && normalized.hasTools === true,
            resolvedFirstTool: normalized === null ? null : normalized.firstTool,
            firstTool: normalized === null ? null : normalized.firstTool,
            resolvedLastTool: normalized === null ? null : normalized.lastTool,
            lastTool: normalized === null ? null : normalized.lastTool,
            resolvedFirstToolVersion: normalized === null ? null : normalized.firstToolVersion,
            ...
            resolvedToolNameList: normalized === null ? null : normalized.toolNameList,
            toolNames: normalized === null ? [] : normalized.toolNames,
            toolNameList: normalized === null ? [] : normalized.toolNameList,
    ...
    case 'native.dylinker': {
        ...
        return {
            ...
            resolvedPath: normalized === null ? null : normalized.path,
            resolvedPathKind: normalized === null ? null : normalized.pathKind,
            resolvedKind: normalized === null ? null : normalized.kind,
            name: normalized === null ? null : normalized.name,
            path: normalized === null ? null : normalized.path,
            pathKind: normalized === null ? null : normalized.pathKind,
            ...
            resolvedIsTokenPath: normalized === null ? null : normalized.isTokenPath,
            isTokenPath: normalized !== null && normalized.isTokenPath === true,
            resolvedUsesLoaderPath: normalized === null ? null : normalized.usesLoaderPath,
            usesLoaderPath: normalized !== null && normalized.usesLoaderPath === true,
            resolvedUsesExecutablePath: normalized === null ? null : normalized.usesExecutablePath,
            usesExecutablePath: normalized !== null && normalized.usesExecutablePath === true,
            resolvedUsesRpathToken: normalized === null ? null : normalized.usesRpathToken,
            usesRpathToken: normalized !== null && normalized.usesRpathToken === true,
            resolvedPathDepth: normalized === null ? 0 : normalized.pathDepth,
            pathDepth: normalized === null ? 0 : normalized.pathDepth,
            resolvedIsWeakDylinker: normalized === null ? null : normalized.isWeakDylinker,
            isWeakDylinker: normalized !== null && normalized.isWeakDylinker === true,
            resolvedIsReexportDylinker: normalized === null ? null : normalized.isReexportDylinker,
            isReexportDylinker: normalized !== null && normalized.isReexportDylinker === true,
            resolvedIsUpwardDylinker: normalized === null ? null : normalized.isUpwardDylinker,
            isUpwardDylinker: normalized !== null && normalized.isUpwardDylinker === true,
            resolvedIsLoadDylinker: normalized === null ? null : normalized.isLoadDylinker,
    ...
    case 'native.install_name': {
        ...
        return {
            ...
            resolvedUsesRpathToken: normalized === null ? null : normalized.usesRpathToken,
            resolvedPathDepth: normalized === null ? 0 : normalized.pathDepth,
            resolvedHasTimestamp: normalized === null ? null : normalized.hasTimestamp,
            resolvedVersionMismatch: normalized === null ? null : normalized.versionMismatch,
            name: normalized === null ? null : normalized.name,
            path: normalized === null ? null : normalized.path,
            pathKind: normalized === null ? null : normalized.pathKind,
            currentVersion: normalized === null ? null : normalized.currentVersion,
    ...
    case 'native.uuid': {
        ...
        return {
            ...
            resolvedNormalizedUuid: normalized === null ? null : normalized.normalizedUuid,
            resolvedHasUuid: normalized === null ? null : normalized.hasUuid,
            resolvedUuidLength: normalized === null ? 0 : normalized.uuidLength,
            resolvedUuidSegmentCount: normalized === null ? 0 : normalized.uuidSegmentCount,
    ...
    case 'native.imports': {
        ...
        return {
            ...
            sourceKindList: sourceKindSummaries.map((item) => item.sourceKind),
            sourcePathKindNames: sourcePathKindSummaries.map((item) => item.sourcePathKind),
            sourcePathKindList: sourcePathKindSummaries.map((item) => item.sourcePathKind),
            importNameList: importNames.map((item) => item.importName),
            normalizedNameList: normalizedNames.map((item) => item.normalizedName),
            dylibSources,
    ...
    case 'native.import_info': {
        ...
        return {
            ...
            resolvedSource: normalized === null ? null : normalized.source,
            resolvedSourceKind: normalized === null ? null : normalized.sourceKind,
            resolvedSourcePathKind: normalized === null ? null : normalized.sourcePathKind,
            resolvedHasDylibName: normalized === null ? null : normalized.hasDylibName,
            resolvedUsesOrdinalOnly: normalized === null ? null : normalized.usesOrdinalOnly,
            resolvedIsMainExecutableImport: normalized === null ? null : normalized.isMainExecutableImport,
            resolvedIsFlatLookupImport: normalized === null ? null : normalized.isFlatLookupImport,
            resolvedIsSelfImport: normalized === null ? null : normalized.isSelfImport,
            resolvedIsTokenSource: normalized === null ? null : normalized.isTokenSource,
            resolvedUsesLoaderPath: normalized === null ? null : normalized.usesLoaderPath,
            resolvedUsesExecutablePath: normalized === null ? null : normalized.usesExecutablePath,
            resolvedUsesRpathToken: normalized === null ? null : normalized.usesRpathToken,
            resolvedWeakImport: normalized === null ? null : normalized.weakImport,
            name: normalized === null ? null : normalized.name,
            ...
            sourcePathKind: normalized === null ? null : normalized.sourcePathKind,
            ...
            isTokenSource: normalized !== null && normalized.isTokenSource === true,
            usesLoaderPath: normalized !== null && normalized.usesLoaderPath === true,
            usesExecutablePath: normalized !== null && normalized.usesExecutablePath === true,
            usesRpathToken: normalized !== null && normalized.usesRpathToken === true,
    ...
    case 'native.segment_info': {
        ...
        return {
            ...
            resolvedHasVmRange: normalized === null ? null : normalized.hasVmRange,
            resolvedHasFileData: normalized === null ? null : normalized.hasFileData,
            resolvedIsEmpty: normalized === null ? null : normalized.isEmpty,
            resolvedIsZeroFillLike: normalized === null ? null : normalized.isZeroFillLike,
            resolvedIsReadable: normalized === null ? null : normalized.isReadable,
            resolvedIsWritable: normalized === null ? null : normalized.isWritable,
            resolvedIsExecutable: normalized === null ? null : normalized.isExecutable,
            name: normalized === null ? null : normalized.name,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            vmaddr: normalized === null ? null : normalized.vmaddr,
            vmEnd: normalized === null ? null : normalized.vmEnd,
    ...
    case 'native.section_info': {
        ...
        return {
            ...
            resolvedHasData: normalized === null ? null : normalized.hasData,
            resolvedIsZeroFillLike: normalized === null ? null : normalized.isZeroFillLike,
            resolvedIsCStringLike: normalized === null ? null : normalized.isCStringLike,
            resolvedIsSymbolPointers: normalized === null ? null : normalized.isSymbolPointers,
            name: normalized === null ? null : normalized.name,
    ...
    case 'native.load_command_info': {
        ...
        return {
            ...
            resolvedIsReqDyld: normalized === null ? null : normalized.isReqDyld,
            resolvedHasPayload: normalized === null ? null : normalized.hasPayload,
            resolvedHasDetail: normalized === null ? null : normalized.hasDetail,
            resolvedHasPath: normalized === null ? null : normalized.hasPath,
            resolvedIsTokenPath: normalized === null ? null : normalized.isTokenPath,
            resolvedUsesLoaderPath: normalized === null ? null : normalized.usesLoaderPath,
            resolvedUsesExecutablePath: normalized === null ? null : normalized.usesExecutablePath,
            resolvedUsesRpathToken: normalized === null ? null : normalized.usesRpathToken,
            resolvedHasCurrentVersion: normalized === null ? null : normalized.hasCurrentVersion,
            resolvedHasCompatibilityVersion: normalized === null ? null : normalized.hasCompatibilityVersion,
            resolvedHasTimestamp: normalized === null ? null : normalized.hasTimestamp,
            resolvedVersionMismatch: normalized === null ? null : normalized.versionMismatch,
            resolvedHasVersion: normalized === null ? null : normalized.hasVersion,
            resolvedHasMinOs: normalized === null ? null : normalized.hasMinOs,
            resolvedHasSdk: normalized === null ? null : normalized.hasSdk,
            resolvedHasTools: normalized === null ? null : normalized.hasTools,
            resolvedToolCount: normalized === null ? 0 : normalized.toolCount,
            resolvedUniqueToolCount: normalized === null ? 0 : normalized.uniqueToolCount,
            resolvedToolNames: normalized === null ? null : normalized.toolNames,
            resolvedToolNameList: normalized === null ? null : normalized.toolNameList,
            resolvedHasUuid: normalized === null ? null : normalized.hasUuid,
            resolvedUuidLength: normalized === null ? 0 : normalized.uuidLength,
            resolvedHasDataRange: normalized === null ? null : normalized.hasDataRange,
            resolvedHasEntryPoint: normalized === null ? null : normalized.hasEntryPoint,
            resolvedHasEncryptedRange: normalized === null ? null : normalized.hasEncryptedRange,
            resolvedHasDyldRegions: normalized === null ? null : normalized.hasDyldRegions,
            resolvedDyldRegionCount: normalized === null ? 0 : normalized.dyldRegionCount,
            resolvedNonEmptyDyldRegionCount: normalized === null ? 0 : normalized.nonEmptyDyldRegionCount,
            resolvedNonEmptyDyldRegionList: normalized === null ? null : normalized.nonEmptyDyldRegionList,
            name: normalized === null ? null : normalized.name,
            ...
            nonEmptyDyldRegionList: normalized === null ? [] : normalized.nonEmptyDyldRegionList,
    ...
    case 'swift.symbols': {
        ...
        return {
            ...
            ownerTypeList: memberSummary.ownerTypes.map((item) => item.ownerTypeName),
            memberKindList: memberSummary.memberKinds.map((item) => item.memberKind),
            resultTypeList: memberSummary.resultTypes.map((item) => item.resultTypeName),
            moduleNameList: moduleSummaries.map((item) => item.moduleName),
            symbolNameList: symbolNames.map((item) => item.symbolName),
    ...
    case 'swift.symbol_info': {
        ...
        return {
            ...
            resolvedAddress: normalized === null ? null : normalized.address,
            resolvedOffsetHex: normalized === null ? null : normalized.offsetHex,
            resolvedOwnerTypeName: normalized === null ? null : normalized.ownerTypeName,
            resolvedMemberName: normalized === null ? null : normalized.memberName,
            resolvedMemberKind: normalized === null ? null : normalized.memberKind,
            resolvedSignature: normalized === null ? null : normalized.signature,
            resolvedResultTypeName: normalized === null ? null : normalized.resultTypeName,
            resolvedHasName: normalized === null ? null : normalized.hasName,
            resolvedHasDemangledName: normalized === null ? null : normalized.hasDemangledName,
            resolvedHasOwnerTypeName: normalized === null ? null : normalized.hasOwnerTypeName,
            resolvedHasMemberName: normalized === null ? null : normalized.hasMemberName,
            resolvedHasSignature: normalized === null ? null : normalized.hasSignature,
            resolvedHasResultTypeName: normalized === null ? null : normalized.hasResultTypeName,
            resolvedIsMember: normalized === null ? null : normalized.isMember,
            resolvedIsAccessor: normalized === null ? null : normalized.isAccessor,
            resolvedIsGetter: normalized === null ? null : normalized.isGetter,
            resolvedIsSetter: normalized === null ? null : normalized.isSetter,
            resolvedIsModifyAccessor: normalized === null ? null : normalized.isModifyAccessor,
            resolvedIsReadAccessor: normalized === null ? null : normalized.isReadAccessor,
            resolvedIsConstructor: normalized === null ? null : normalized.isConstructor,
            resolvedIsDestructor: normalized === null ? null : normalized.isDestructor,
            resolvedIsSubscript: normalized === null ? null : normalized.isSubscript,
            resolvedIsOperator: normalized === null ? null : normalized.isOperator,
            resolvedIsClosure: normalized === null ? null : normalized.isClosure,
            resolvedIsStaticMember: normalized === null ? null : normalized.isStaticMember,
            resolvedIsClassMember: normalized === null ? null : normalized.isClassMember,
            resolvedIsMutating: normalized === null ? null : normalized.isMutating,
            resolvedIsDispatchThunk: normalized === null ? null : normalized.isDispatchThunk,
            resolvedIsAsync: normalized === null ? null : normalized.isAsync,
            resolvedIsThrowing: normalized === null ? null : normalized.isThrowing,
            resolvedThrowsKind: normalized === null ? null : normalized.throwsKind,
            name: normalized === null ? null : normalized.name,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            demangledName: normalized === null ? null : normalized.demangledName,
            address: normalized === null ? null : normalized.address,
            offsetHex: normalized === null ? null : normalized.offsetHex,
    ...
    case 'swift.protocol_info': {
        ...
        return {
            ...
            resolvedQualifiedName: normalized === null ? null : normalized.qualifiedName,
            resolvedSignature: normalized === null ? null : normalized.signature,
            resolvedContextModuleName: normalized === null ? null : normalized.contextModuleName,
            resolvedDetailKind: normalized === null ? null : normalized.detailKind,
            resolvedSourceKind: normalized === null ? null : normalized.sourceKind,
            resolvedHasName: normalized === null ? null : normalized.hasName,
            resolvedHasSourceKind: normalized === null ? null : normalized.hasSourceKind,
            resolvedHasSourceSymbolName: normalized === null ? null : normalized.hasSourceSymbolName,
            resolvedHasSourceDemangledName: normalized === null ? null : normalized.hasSourceDemangledName,
            resolvedHasQualifiedName: normalized === null ? null : normalized.hasQualifiedName,
            resolvedHasSignature: normalized === null ? null : normalized.hasSignature,
            resolvedHasContextModuleName: normalized === null ? null : normalized.hasContextModuleName,
            resolvedHasDetailKind: normalized === null ? null : normalized.hasDetailKind,
            resolvedIsDescriptor: normalized === null ? null : normalized.isDescriptor,
            name: normalized === null ? null : normalized.name,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            sourceSymbolName: normalized === null ? null : normalized.sourceSymbolName,
            sourceAddress: normalized === null ? null : normalized.sourceAddress,
            sourceOffsetHex: normalized === null ? null : normalized.sourceOffsetHex,
            sourceDemangledName: normalized === null ? null : normalized.sourceDemangledName,
    ...
    case 'swift.conformance_info': {
        ...
        return {
            ...
            resolvedSourceDemangledName: normalized === null ? null : normalized.sourceDemangledName,
            resolvedSignature: normalized === null ? null : normalized.signature,
            resolvedRelation: normalized === null ? null : normalized.relation,
            resolvedContextModuleName: normalized === null ? null : normalized.contextModuleName,
            resolvedWhereClause: normalized === null ? null : normalized.whereClause,
            resolvedDetailKind: normalized === null ? null : normalized.detailKind,
            resolvedSourceKind: normalized === null ? null : normalized.sourceKind,
            resolvedHasTypeName: normalized === null ? null : normalized.hasTypeName,
            resolvedHasProtocolName: normalized === null ? null : normalized.hasProtocolName,
            resolvedHasSourceKind: normalized === null ? null : normalized.hasSourceKind,
            resolvedHasSourceSymbolName: normalized === null ? null : normalized.hasSourceSymbolName,
            resolvedHasSourceDemangledName: normalized === null ? null : normalized.hasSourceDemangledName,
            resolvedHasSignature: normalized === null ? null : normalized.hasSignature,
            resolvedHasRelation: normalized === null ? null : normalized.hasRelation,
            resolvedHasContextModuleName: normalized === null ? null : normalized.hasContextModuleName,
            resolvedHasWhereClause: normalized === null ? null : normalized.hasWhereClause,
            resolvedHasDetailKind: normalized === null ? null : normalized.hasDetailKind,
            resolvedIsDescriptor: normalized === null ? null : normalized.isDescriptor,
            resolvedIsWitnessTable: normalized === null ? null : normalized.isWitnessTable,
            resolvedIsWitnessAccessor: normalized === null ? null : normalized.isWitnessAccessor,
            resolvedIsWitness: normalized === null ? null : normalized.isWitness,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            sourceSymbolName: normalized === null ? null : normalized.sourceSymbolName,
            sourceAddress: normalized === null ? null : normalized.sourceAddress,
            sourceOffsetHex: normalized === null ? null : normalized.sourceOffsetHex,
    ...
    case 'swift.protocols': {
        ...
        return {
            ...
            uniqueDetailKindCount: detailKinds.length,
            moduleNameList: moduleSummaries.map((item) => item.moduleName),
            protocolNameList: protocolNames.map((item) => item.protocolName),
            moduleNames: moduleSummaries,
            protocolNames,
            contextModuleNameList: contextModules.map((item) => item.contextModuleName),
            detailKindList: detailKinds.map((item) => item.detailKind),
    ...
    case 'swift.conformances': {
        ...
        return {
            ...
            moduleNameList: moduleSummaries.map((item) => item.moduleName),
            protocolNameList: protocols.map((item) => item.protocolName),
    ...
    case 'swift.metadata_info': {
        ...
        return {
            ...
            resolvedHasContextModuleName: normalized === null ? null : normalized.hasContextModuleName,
            resolvedHasDetailKind: normalized === null ? null : normalized.hasDetailKind,
            resolvedIsMetadata: normalized === null ? null : normalized.isMetadata,
            resolvedIsMetadataAccessor: normalized === null ? null : normalized.isMetadataAccessor,
            resolvedIsNominalDescriptor: normalized === null ? null : normalized.isNominalDescriptor,
            name: normalized === null ? null : normalized.name,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            sourceSymbolName: normalized === null ? null : normalized.sourceSymbolName,
            sourceAddress: normalized === null ? null : normalized.sourceAddress,
    ...
    case 'swift.vtable': {
        ...
        return {
            ...
            resultTypes: memberSummary.resultTypes,
            moduleNameList: moduleSummaries.map((item) => item.moduleName),
            memberNameList: memberNames.map((item) => item.memberName),
            typeNameList: types.map((item) => item.typeName),
            sourceKindList: sourceKinds.map((item) => item.sourceKind),
            moduleNames: moduleSummaries,
            memberNames,
            types,
    ...
    case 'swift.vtable_info': {
        ...
        return {
            ...
            resolvedIsThrowing: normalized === null ? null : normalized.isThrowing,
            resolvedThrowsKind: normalized === null ? null : normalized.throwsKind,
            memberKey: normalized === null ? null : normalized.memberKey,
            name: normalized === null ? null : normalized.name,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            demangledName: normalized === null ? null : normalized.demangledName,
            address: normalized === null ? null : normalized.address,
    ...
    case 'swift.witness_table': {
        ...
        return {
            ...
            typeNameList: typeSummaries.map((item) => item.typeName),
            protocolNameList: protocols.map((item) => item.protocolName),
            witnessKeyList: witnessKeys.map((item) => item.witnessKey),
            typeNames: typeSummaries,
            moduleNames: moduleSummaries,
            protocols,
            witnessKeys,
    ...
    case 'swift.witness_table_info': {
        ...
        return {
            ...
            resolvedIsWitness: normalized === null ? null : normalized.isWitness,
            resolvedIsAccessor: normalized === null ? null : normalized.isAccessor,
            witnessKey: normalized === null ? null : normalized.witnessKey,
            name: normalized === null ? null : normalized.name,
            moduleBase: normalized === null ? null : normalized.moduleBase,
            demangledName: normalized === null ? null : normalized.demangledName,
            address: normalized === null ? null : normalized.address,
    ...
    case 'swift.type_layout_info': {
        ...
        return {
            ...
            resolvedFirstMetadataAccessorName: normalized === null ? null : normalized.firstMetadataAccessorName,
            resolvedLastMetadataAccessorName: normalized === null ? null : normalized.lastMetadataAccessorName,
            resolvedFirstNominalDescriptorName: normalized === null ? null : normalized.firstNominalDescriptorName,
            resolvedLastNominalDescriptorName: normalized === null ? null : normalized.lastNominalDescriptorName,
            resolvedFirstMetadataCacheName: normalized === null ? null : normalized.firstMetadataCacheName,
            resolvedLastMetadataCacheName: normalized === null ? null : normalized.lastMetadataCacheName,
            resolvedFirstAssociatedTypeDescriptorName: normalized === null ? null : normalized.firstAssociatedTypeDescriptorName,
            resolvedLastAssociatedTypeDescriptorName: normalized === null ? null : normalized.lastAssociatedTypeDescriptorName,
            resolvedFirstVtableMemberName: normalized === null ? null : normalized.firstVtableMemberName,
            resolvedLastVtableMemberName: normalized === null ? null : normalized.lastVtableMemberName,
            resolvedFirstWitnessProtocolName: normalized === null ? null : normalized.firstWitnessProtocolName,
            resolvedLastWitnessProtocolName: normalized === null ? null : normalized.lastWitnessProtocolName,
            resolvedHasMetadata: normalized === null ? null : normalized.hasMetadata,
            resolvedHasMetadataAccessors: normalized === null ? null : normalized.hasMetadataAccessors,
            resolvedHasNominalDescriptors: normalized === null ? null : normalized.hasNominalDescriptors,
            resolvedHasMetadataCaches: normalized === null ? null : normalized.hasMetadataCaches,
            resolvedHasAssociatedTypeDescriptors: normalized === null ? null : normalized.hasAssociatedTypeDescriptors,
            resolvedHasVtableEntries: normalized === null ? null : normalized.hasVtableEntries,
            resolvedHasWitnessTables: normalized === null ? null : normalized.hasWitnessTables,
            resolvedMetadataCount: normalized === null ? 0 : normalized.metadataCount,
            resolvedMetadataAccessorCount: normalized === null ? 0 : normalized.metadataAccessorCount,
            resolvedNominalDescriptorCount: normalized === null ? 0 : normalized.nominalDescriptorCount,
            resolvedMetadataCacheCount: normalized === null ? 0 : normalized.metadataCacheCount,
            resolvedAssociatedTypeDescriptorCount: normalized === null ? 0 : normalized.associatedTypeDescriptorCount,
            resolvedTypeSourceEntryCount: normalized === null ? 0 : normalized.typeSourceEntryCount,
            resolvedSourceDemangledCount: normalized === null ? 0 : normalized.sourceDemangledCount,
            resolvedHasSourceDemangledTypes: normalized === null ? null : normalized.hasSourceDemangledTypes,
            resolvedUniqueSourceKindCount: normalized === null ? 0 : normalized.uniqueSourceKindCount,
            resolvedUniqueContextModuleCount: normalized === null ? 0 : normalized.uniqueContextModuleCount,
            resolvedUniqueDetailKindCount: normalized === null ? 0 : normalized.uniqueDetailKindCount,
            resolvedContextModuleNameList: normalized === null ? [] : normalized.contextModuleNameList,
            resolvedDetailKindList: normalized === null ? [] : normalized.detailKindList,
            resolvedSourceKindList: normalized === null ? [] : normalized.sourceKindList,
            resolvedSourceKinds: normalized === null ? [] : normalized.sourceKinds,
            resolvedContextModules: normalized === null ? [] : normalized.contextModules,
            resolvedDetailKinds: normalized === null ? [] : normalized.detailKinds,
            resolvedVtableCount: normalized === null ? 0 : normalized.vtableCount,
            resolvedWitnessTableCount: normalized === null ? 0 : normalized.witnessTableCount,
            resolvedParsedVtableMemberCount: normalized === null ? 0 : normalized.parsedVtableMemberCount,
            resolvedVtableAccessorCount: normalized === null ? 0 : normalized.vtableAccessorCount,
            resolvedVtableGetterCount: normalized === null ? 0 : normalized.vtableGetterCount,
            resolvedVtableSetterCount: normalized === null ? 0 : normalized.vtableSetterCount,
            resolvedVtableModifyAccessorCount: normalized === null ? 0 : normalized.vtableModifyAccessorCount,
            resolvedVtableReadAccessorCount: normalized === null ? 0 : normalized.vtableReadAccessorCount,
            resolvedVtableConstructorCount: normalized === null ? 0 : normalized.vtableConstructorCount,
            resolvedVtableDestructorCount: normalized === null ? 0 : normalized.vtableDestructorCount,
            resolvedVtableSubscriptCount: normalized === null ? 0 : normalized.vtableSubscriptCount,
            resolvedVtableOperatorCount: normalized === null ? 0 : normalized.vtableOperatorCount,
            resolvedVtableClosureCount: normalized === null ? 0 : normalized.vtableClosureCount,
            resolvedVtableStaticMemberCount: normalized === null ? 0 : normalized.vtableStaticMemberCount,
            resolvedVtableClassMemberCount: normalized === null ? 0 : normalized.vtableClassMemberCount,
            resolvedVtableMutatingMemberCount: normalized === null ? 0 : normalized.vtableMutatingMemberCount,
            resolvedVtableAsyncCount: normalized === null ? 0 : normalized.vtableAsyncCount,
            resolvedVtableThrowingCount: normalized === null ? 0 : normalized.vtableThrowingCount,
            resolvedVtableDispatchThunkCount: normalized === null ? 0 : normalized.vtableDispatchThunkCount,
            resolvedWitnessAccessorCount: normalized === null ? 0 : normalized.witnessAccessorCount,
            resolvedWitnessDemangledCount: normalized === null ? 0 : normalized.witnessDemangledCount,
            resolvedUniqueVtableOwnerTypeCount: normalized === null ? 0 : normalized.uniqueVtableOwnerTypeCount,
            resolvedUniqueVtableMemberKindCount: normalized === null ? 0 : normalized.uniqueVtableMemberKindCount,
            resolvedUniqueVtableResultTypeCount: normalized === null ? 0 : normalized.uniqueVtableResultTypeCount,
            resolvedUniqueWitnessProtocolCount: normalized === null ? 0 : normalized.uniqueWitnessProtocolCount,
            resolvedUniqueWitnessSourceKindCount: normalized === null ? 0 : normalized.uniqueWitnessSourceKindCount,
            resolvedVtableOwnerTypes: normalized === null ? [] : normalized.vtableOwnerTypes,
            resolvedVtableMemberKinds: normalized === null ? [] : normalized.vtableMemberKinds,
            resolvedVtableResultTypes: normalized === null ? [] : normalized.vtableResultTypes,
            resolvedWitnessProtocols: normalized === null ? [] : normalized.witnessProtocols,
            resolvedWitnessSourceKinds: normalized === null ? [] : normalized.witnessSourceKinds,
            hasName: normalized !== null && normalized.hasName === true,
            ...
            metadata: normalized === null ? [] : normalized.metadata,
            metadataAccessors: normalized === null ? [] : normalized.metadataAccessors,
            nominalDescriptors: normalized === null ? [] : normalized.nominalDescriptors,
            metadataCaches: normalized === null ? [] : normalized.metadataCaches,
            associatedTypeDescriptors: normalized === null ? [] : normalized.associatedTypeDescriptors,
            vtableEntries: normalized === null ? [] : normalized.vtableEntries,
            witnessTables: normalized === null ? [] : normalized.witnessTables,
            ...
            contextModuleNameList: normalized === null ? [] : normalized.contextModuleNameList,
            detailKindList: normalized === null ? [] : normalized.detailKindList,
            sourceKindList: normalized === null ? [] : normalized.sourceKindList,
    ...
    case 'swift.method_owners': {
        ...
        return {
            ...
            uniqueContextModuleCount: contextModules.length,
            uniqueDetailKindCount: detailKinds.length,
            ownerNameList: ownerNames.map((item) => item.ownerName),
            moduleNameList: moduleSummaries.map((item) => item.moduleName),
            ownerNames,
            moduleNames: moduleSummaries,
            contextModuleNameList: contextModules.map((item) => item.contextModuleName),
    ...
    case 'swift.type_methods': {
        ...
        return {
            ...
            resultTypes: memberSummary.resultTypes,
            moduleNameList: moduleSummaries.map((item) => item.moduleName),
            methodNameList: methodNames.map((item) => item.methodName),
            moduleNames: moduleSummaries,
            methodNames,
            methods,
...
function legacyToSpec(command) {
    ...
    if (trimmed.startsWith('swift.findSymbolInfo ')) {
        const usage = 'swift.findSymbolInfo usage: swift.findSymbolInfo <symbol> | swift.findSymbolInfo <module> -- <symbol>';
        const parsed = splitModuleQuery(trimmed.slice('swift.findSymbolInfo '.length), usage);
        return {
            kind: 'swift.symbol_info',
            moduleName: parsed.moduleName,
            symbolName: parsed.query,
    ...
    if (trimmed.startsWith('swift.findProtocolInfo ')) {
        const usage = 'swift.findProtocolInfo usage: swift.findProtocolInfo <protocol> | swift.findProtocolInfo <module> -- <protocol>';
        const parsed = splitModuleQuery(trimmed.slice('swift.findProtocolInfo '.length), usage);
        return {
            kind: 'swift.protocol_info',
            moduleName: parsed.moduleName,
            protocolName: parsed.query,
    ...
    if (trimmed.startsWith('swift.findConformanceInfo ')) {
        const usage = 'swift.findConformanceInfo usage: swift.findConformanceInfo <type> <protocol> | swift.findConformanceInfo <module> -- <type> <protocol>';
        const parsed = splitModuleQuery(trimmed.slice('swift.findConformanceInfo '.length), usage);
        const parts = parsed.query.split(/\s+/).filter(Boolean);
        if (parts.length < 2) {
            throw new Error(usage);
        }
    ...
    if (trimmed.startsWith('swift.findMetadataInfo ')) {
        const usage = 'swift.findMetadataInfo usage: swift.findMetadataInfo <type> | swift.findMetadataInfo <module> -- <type>';
        const parsed = splitModuleQuery(trimmed.slice('swift.findMetadataInfo '.length), usage);
        return {
            kind: 'swift.metadata_info',
            moduleName: parsed.moduleName,
            typeName: parsed.query,
    ...
    if (trimmed.startsWith('swift.findTypeInfo ')) {
        const usage = 'swift.findTypeInfo usage: swift.findTypeInfo <type> | swift.findTypeInfo <module> -- <type>';
        const parsed = splitModuleQuery(trimmed.slice('swift.findTypeInfo '.length), usage);
        return {
            kind: 'swift.type_info',
            moduleName: parsed.moduleName,
            typeName: parsed.query,
    ...
    if (trimmed.startsWith('swift.findMethodInfo ')) {
        const usage = 'swift.findMethodInfo usage: swift.findMethodInfo <type> <method> | swift.findMethodInfo <module> -- <type> <method>';
        const parsed = splitSwiftMethods(trimmed.slice('swift.findMethodInfo '.length), usage);
        return {
            kind: 'swift.method_info',
            moduleName: parsed.moduleName,
            typeName: parsed.typeName,
    ...
    if (trimmed.startsWith('swift.findVtableInfo ')) {
        const usage = 'swift.findVtableInfo usage: swift.findVtableInfo <type> <member> | swift.findVtableInfo <module> -- <type> <member>';
        const parsed = splitSwiftMethods(trimmed.slice('swift.findVtableInfo '.length), usage);
        return {
            kind: 'swift.vtable_info',
            moduleName: parsed.moduleName,
            typeName: parsed.typeName,
    ...
    if (trimmed.startsWith('swift.findWitnessTableInfo ')) {
        const usage = 'swift.findWitnessTableInfo usage: swift.findWitnessTableInfo <type> <protocol> | swift.findWitnessTableInfo <module> -- <type> <protocol>';
        const parsed = splitSwiftMethods(trimmed.slice('swift.findWitnessTableInfo '.length), usage);
        return {
            kind: 'swift.witness_table_info',
            moduleName: parsed.moduleName,
            typeName: parsed.typeName,
    ...
    if (trimmed.startsWith('swift.findTypeLayoutInfo ')) {
        const usage = 'swift.findTypeLayoutInfo usage: swift.findTypeLayoutInfo <type> | swift.findTypeLayoutInfo <module> -- <type>';
        const parsed = splitModuleQuery(trimmed.slice('swift.findTypeLayoutInfo '.length), usage);
        return {
            kind: 'swift.type_layout_info',
            moduleName: parsed.moduleName,
            typeName: parsed.query,
