...
/* PACIASP - Sign LR with SP using IA key */
void arm64_writer_put_paciasp(Arm64Writer* w);

/* AUTIASP - Authenticate LR with SP using IA key */
...
/* RETAA - Authenticate LR with SP and return */
void arm64_writer_put_retaa(Arm64Writer* w);

/* RETAB - Authenticate LR with SP using IB key and return */
