...
- `swift.typeLayoutInfo` 现在也进一步把 `first/last MetadataAccessor / NominalDescriptor / VtableMember / WitnessProtocol` 这类首尾摘要平铺到了顶层，脚本侧先抓布局概览时不必每次再进 `typeLayout.*` 里取首个/末个名字。
